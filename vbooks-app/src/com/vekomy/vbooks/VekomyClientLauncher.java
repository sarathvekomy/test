 ...
 * 
 */
public class VekomyClientLauncher extends Activity {

	/**
	 * Tag constant to log the information.
	 */
	private static final String LOG_TAG = "VekomyClientLauncher";
	...
	public void onCreate(Bundle bundle) {
		...
		Log.d(LOG_TAG, "VekomyClientLauncher onCreate");
	...
	private void connectToLauncherService() {
		...
		if (launcherServiceConnection != null) {
			Intent intent = new Intent(VekomyClientLauncher.this, LauncherService.class);
