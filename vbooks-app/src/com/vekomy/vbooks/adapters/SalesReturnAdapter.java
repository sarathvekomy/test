 ...
 *
 */
public class SalesReturnAdapter  extends ArrayAdapter<SalesReturnProduct>
{
	...
	public SalesReturnAdapter(Context context, int resource,List<SalesReturnProduct> productsInfoList,boolean isView)
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		try
		{
			...
			if (rowView == null)
			{
				rowView = mInflater.inflate(R.layout.sales_returns_products_row, null);
			...
			if(product!=null)
			{
				...
				viewHolder.txtReSaleQty.setText(product.getResaleQty()==0?"":String.valueOf(product.getResaleQty()));
				viewHolder.txtDamagedQty.setText(product.getDamagedQty()==0?"":String.valueOf(product.getDamagedQty()));
