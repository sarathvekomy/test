...
insert into vb_role values(7,'ROLE_SUPER_MANAGEMENT','Super Management');

insert into vb_organization values(1, '', 'User Group', 'User Group', 'UG', '', '', '', 'Organization Group', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',' ');

insert into vb_login values(1,'admin','21232f297a57a5a743894a0e4a801fc3', 1,'N', 0, 1);
...
insert into vb_authority values(7,1,7);



insert into vb_notifications(id,notification_type) values (1,'In_System_Alert');
