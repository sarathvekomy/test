...
drop table if exists vb_system_notifications;
drop table if exists vb_authority;
drop table if exists vb_login_track;
drop table if exists vb_insystem_alert_notifications;
drop table if exists vb_login;
drop table if exists vb_customer_credit_transaction;
drop table if exists vb_customer_debit_transaction;
...
drop table if exists vb_day_book_vehicle_details;
drop table if exists vb_day_book;
drop table if exists vb_cash_day_book_cr;
drop table if exists vb_cash_day_book;
...
drop table if exists vb_invoice_no_period;
...
drop table if exists vb_product_categories;
...
(
  ...
  user_name_prefix varchar(30) not null,
...
/*--------------------------- table : vb_product_category----------------------------*/
create table vb_product_categories
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by varchar(50),
...
create index vb_product_categories_index on vb_product_categories(id);

/*--------------------------- table : vb_invoice_no_period--------------------------*/

create table vb_invoice_no_period
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by varchar(50),
  ...
  modified_by varchar(50),
  txn_type varchar(30),
  start_value varchar(30) not null,
  period varchar(30) not null,
  description text,
  organization_id int(7) not null,
  foreign key (organization_id) references vb_organization(id)
);
create index vb_invoice_no_period_index on vb_invoice_no_period(id);
...
(
  ...
  employee_Hierarchy_level int(7) not null,
...
/*---------------------------  table : table in DB to save previousfo  ---------------------------*/
...
(
  ...
  business_name varchar(100) not null,
  invoice_name varchar(100) not null,
  products_grand_total float(20,2),
  sales_id int(7) not null,
  status varchar(20),
  flag int(7),
  remarks text,
...
(
  ...
  resalable int(10),
  total_qty int(10),
  resalable_cost float(20,2),
  damaged_cost float(20,2),
  total_cost float(20,2) not null,
...
(
  ...
  resalable_cost varchar(20),
  damaged_cost varchar(20),
  total_cost varchar(20) not null,
...
(
  ...
  vehicle_details_remarks text,
  organization_id int(7) not null,
  day_book_remarks text,
  foreign key (sales_id) references vb_sales_book(id),
  foreign key (organization_id) references vb_organization(id)
);
...
(
  ...
  reason_dealer_party_expenses text,
...
(
  ...
  products_remarks text,
  foreign key (day_book_id) references vb_day_book(id)
);

create index vb_day_book_products_index on vb_day_book_products(id);

/*---------------------------  table : vb_day_book_vehicle_details  ---------------------------*/

create table vb_day_book_vehicle_details
(
  id int(7) not null auto_increment primary key,
  day_book_id int(7) not null,
  driver_name varchar(50),
...
create index vb_day_book_vehicle_details_index on vb_day_book_vehicle_details(id);

/*---------------------------  table : vb_cash_day_book  ---------------------------*/

create table vb_cash_day_book
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by text,
...
create index vb_cash_day_book_index on vb_cash_day_book(id);

/*---------------------------  table : vb_cash_day_book_cr  ---------------------------*/

create table vb_cash_day_book_cr
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by text,
  ...
  value_three text,
  sales_id int(7) not null,
  cash_day_book_id int(7) not null,
  organization_id int(7) not null,
  foreign key (sales_id) references vb_sales_book(id),
  foreign key (cash_day_book_id) references vb_cash_day_book(id),
  foreign key (organization_id) references vb_organization(id)
);

create index vb_cash_day_book_cr_index on vb_cash_day_book_cr(id);
...
/*---------------------------  table : vb_customer_credit_transaction  ---------------------------*/

create table vb_customer_credit_transaction
(
  id int(7)not null auto_increment primary key,
  credit_from text,
  debit_to text,
...
create index vb_customer_credit_transaction_index on vb_customer_credit_transaction(id);

/*---------------------------  table : vb_customer_debit_transaction  ---------------------------*/

create table vb_customer_debit_transaction
(
  id int(7)not null auto_increment primary key,
  credit_from text,
  debit_to text,
...
create index vb_customer_debit_transaction_index on vb_customer_debit_transaction(id);

/*---------------------------  table : vb_system_notifications  ---------------------------*/

create table vb_system_notifications
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by text,
...
create index vb_system_notifications_index on vb_system_notifications(id);



/*---------------------------  table : vb_insystem_alert_notifications  ---------------------------*/

create table vb_insystem_alert_notifications
(
  id int(7)not null auto_increment primary key,
  created_on datetime,
  created_by text,
...
create index vb_insystem_alert_notifications_index on vb_insystem_alert_notifications(id);