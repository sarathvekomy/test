 ...
 */
public String getExistedStartReading(Integer salesBookId,String dayBookType, String userName,
	...
	if(salesBook.getAllotmentType().equalsIgnoreCase("non-daily")){
		...
		salesBook = (VbSalesBook)session.get(VbSalesBook.class, salesBookId);
	}
 ...
 */
@SuppressWarnings("unchecked")
public List<DayBookAllowancesResult> getAllowances(Integer salesBookId,String userName, VbOrganization organization) throws DataAccessException {
	Session session = this.getSession();
	Date date = new Date();
	VbSalesBook salesBook = (VbSalesBook)session.get(VbSalesBook.class, salesBookId);
	//VbSalesBook salesBook = getVbSalesBookNoFlag(session, userName, organization);
 ...
 */
@SuppressWarnings("unchecked")
public List<DayBookAllowancesResult> getExecutiveAllowances(Integer salesBookId,String userName, VbOrganization organization, String dayBookType) throws DataAccessException {
	Session session = this.getSession();
	VbSalesBook salesBook = (VbSalesBook)session.get(VbSalesBook.class, salesBookId);
	//VbSalesBook salesBook = getVbSalesBookNoFlag(session, userName, organization);
	if(salesBook.getAllotmentType().equalsIgnoreCase("non-daily")){
