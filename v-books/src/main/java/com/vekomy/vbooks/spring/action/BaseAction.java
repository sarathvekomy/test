...
public abstract class BaseAction {
	...
	public abstract IResult process(Object form);
	...
	/**
	 * This method is responsible for preparing {@link ResultError} instance.
	 * 
	 * @param errorMessage - {@link String}
	 * @return resultError - {@link ResultError}
	 */
	public ResultError getResultError(String errorMessage) {
		ResultError resultError = new  ResultError();
		resultError.setMessage(errorMessage);
		resultError.setStatus(OrganizationUtils.RESULT_STATUS_FAILURE);
