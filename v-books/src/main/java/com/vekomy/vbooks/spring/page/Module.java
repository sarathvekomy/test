...
public class Module implements Serializable{
	 ...
	 */
	private static final long serialVersionUID = 5955214587406431790L;
	...
	/**
	 * String variable holds label.
	 */
	private String label;

	/**
	 * String variable holds icon.
	 */
	private String icon;

	/**
	 * LinkedHashMap variable holds pages.
	 */
