/**
 * com.vekomy.vbooks.reports.controller.ReportsController.java
 *
 ...
 *
 */
public class ReportsController extends JsonFormController {
	/**
	...
	public ModelAndView onSubmit(HttpServletRequest request,
		...
		IResult result = getAction(request, "reportsAction").process(command);
