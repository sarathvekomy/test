...
public class DateUtils {
	...
	/**
	 * This method is responsible for getting no.of days in the given month
	 * 
	 * @param currentDate
	 * @return
	 */
	public static int getNumberOfDays(Date currentDate){
		String stDate = DateUtils.formatDateWithTimestamp(currentDate);
	...
	/**
	 * This Method Is Responsible for Getting end date based on no.of days in month
	 * 
	 * @param startDate
	 * @param days
	 * @return
	 */
	public static Date getEndDayForMonth(Date currentDate, int numberOfDays) {
		Date previousDate = null;
		if(currentDate != null) {
			calendar.setTime(currentDate);
