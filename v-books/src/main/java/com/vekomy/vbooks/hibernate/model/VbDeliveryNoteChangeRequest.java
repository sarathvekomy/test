...
public class VbDeliveryNoteChangeRequest implements java.io.Serializable {
	...
	private Set<VbDeliveryNoteChangeRequestProducts> vbDeliveryNoteChangeRequestProductses = new HashSet<VbDeliveryNoteChangeRequestProducts>(
			0);
	private Set<VbDeliveryNoteChangeRequestPayments> vbDeliveryNoteChangeRequestPaymentses = new HashSet<VbDeliveryNoteChangeRequestPayments>(
			0);
	...
	public VbDeliveryNoteChangeRequest(
			...
			Set<VbDeliveryNoteChangeRequestProducts> vbDeliveryNoteChangeRequestProductses,
			Set<VbDeliveryNoteChangeRequestPayments> vbDeliveryNoteChangeRequestPaymentses) {
		this.vbSalesBook = vbSalesBook;
		this.vbOrganization = vbOrganization;
		this.invoiceNo = invoiceNo;
	...
	public Set<VbDeliveryNoteChangeRequestProducts> getVbDeliveryNoteChangeRequestProductses() {
	...
	public Set<VbDeliveryNoteChangeRequestPayments> getVbDeliveryNoteChangeRequestPaymentses() {
