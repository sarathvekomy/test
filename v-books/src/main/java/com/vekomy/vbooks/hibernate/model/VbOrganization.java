...
public class VbOrganization implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = 256056221463008725L;
	private Integer id;
	...
	public VbOrganization(String superUserName, String name,
			...
			String email, Date createdOn, String createdBy, Date modifiedOn,
			String modifiedBy, Set vbCustomerCreditInfos, Set vbJournalTypeses,
			Set vbDeliveryNotes, Set vbEmployees, Set vbCustomerChangeRequests,
			...
			Set vbCustomerAdvanceInfos, Set vbJournals,
			Set vbAssignOrganizationses, Set vbSalesBooks,
			Set vbUserDefinedAlertses, Set vbProductInventoryTransactions,
			Set vbDeliveryNoteChangeRequests, Set vbSalesReturns,
			Set vbDayBookChangeRequests, Set vbAddressTypeses, Set vbProducts,
			Set vbCustomers, Set vbProductCustomerCosts,
			Set vbEmployeeCustomers, Set vbJournalChangeRequests,
