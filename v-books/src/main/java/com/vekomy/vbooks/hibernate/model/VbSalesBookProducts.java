...
public class VbSalesBookProducts implements java.io.Serializable {
	...
	public VbSalesBookProducts(VbSalesBook vbSalesBook, String productName,
			String batchNumber, Integer recentAllotment, Integer qtyAllotted,
			Integer qtyOpeningBalance, Integer qtySold, Integer qtyToFactory,
			Integer qtyClosingBalance, String remarks) {
		this.vbSalesBook = vbSalesBook;
		this.productName = productName;
		this.batchNumber = batchNumber;
