...
public class VbCustomerChangeRequest implements java.io.Serializable {
	...
	private Set<VbCustomerChangeRequestDetails> vbCustomerChangeRequestDetailses = new HashSet<VbCustomerChangeRequestDetails>(
			0);
	...
	public VbCustomerChangeRequest(VbOrganization vbOrganization,
			...
			Set<VbCustomerChangeRequestDetails> vbCustomerChangeRequestDetailses) {
		this.vbOrganization = vbOrganization;
		this.businessName = businessName;
		this.gender = gender;
	...
	public Set<VbCustomerChangeRequestDetails> getVbCustomerChangeRequestDetailses() {
