...
public class VbDeliveryNote implements java.io.Serializable {
	...
	private Set<VbDeliveryNotePayments> vbDeliveryNotePaymentses = new HashSet<VbDeliveryNotePayments>(
			0);
	private Set<VbDeliveryNoteProducts> vbDeliveryNoteProductses = new HashSet<VbDeliveryNoteProducts>(
			0);
	...
	public VbDeliveryNote(VbSalesBook vbSalesBook,
			...
			Set<VbDeliveryNotePayments> vbDeliveryNotePaymentses,
			Set<VbDeliveryNoteProducts> vbDeliveryNoteProductses) {
		this.vbSalesBook = vbSalesBook;
		this.vbOrganization = vbOrganization;
		this.invoiceNo = invoiceNo;
	...
	public Set<VbDeliveryNotePayments> getVbDeliveryNotePaymentses() {
		return this.vbDeliveryNotePaymentses;
	}

	public void setVbDeliveryNotePaymentses(
			Set<VbDeliveryNotePayments> vbDeliveryNotePaymentses) {
		this.vbDeliveryNotePaymentses = vbDeliveryNotePaymentses;
	}

	public Set<VbDeliveryNoteProducts> getVbDeliveryNoteProductses() {
		return this.vbDeliveryNoteProductses;
	}

	public void setVbDeliveryNoteProductses(
			Set<VbDeliveryNoteProducts> vbDeliveryNoteProductses) {
		this.vbDeliveryNoteProductses = vbDeliveryNoteProductses;
	}
