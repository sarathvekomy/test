...
public class SalesBookController extends JsonFormController {
	 ...
	 */
	private static final Logger _logger = LoggerFactory.getLogger(SalesBookController.class);
	...
	protected Object formBackingObject(HttpServletRequest request)
		...
		if ("search-sales-return-data-onload".equals(action) || "search-sales-return".equals(action)) {
			return new SalesReturnCommand();
		} else if ("search-sales-data-onload".equals(action) || "search-sales".equals(action)) {
