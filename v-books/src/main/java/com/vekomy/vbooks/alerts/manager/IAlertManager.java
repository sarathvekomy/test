...
public interface IAlertManager {
	...
	public abstract void fireSystemAlert(VbOrganization organization,
			String userName, String toRecipient, String alertType, String description);
	...
	public abstract void fireUserDefinedAlert(VbOrganization organization,
			String userName, String toRecipient, String alertType, String alertMysales,
			String alertMysalesPage, String description);
	 ...
	 * 
	 */
	public abstract void sendMail(String from, StringBuffer to, StringBuffer cc,
