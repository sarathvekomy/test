...
<div id="reports-add-form-container" title="Product Wise Report"
	style="overflow: auto;">
	...
	<div class="ui-content form-panel full-content">
		<form id="product-wise-report-form" style="height: 150px">
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 60px;">
					<div class="form-row">
						...
						<div class="input-field">
							<select name="organization" id="organization" class="mandatory constrained" constraints='{"fieldLabel":"Organization Type"}'>
				...
				<div class="fieldset" style="height: 60px;">
					<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.REPORT_TYPE_LABEL)%></div>
						<div class="input-field">
		...
		<div id="page-buttons" class="page-buttons" style="margin-left: 130px; margin-top: 10px; position: relative;">
			<div id="action-show" class="ui-btn btn-show">Show</div>
			<div id="action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
		<div id="report-show-dialog" style="display: none; overflow-y: hidden;" title="Product Wise Report">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		ProductWiseReportHandler.load();
		ProductWiseReportHandler.registorReportShowEvents();
