				...
				<div class="dashboard-page-container">
					<div id="login-page" class="ui-container login-page">
						...
						<div id="login-page-content" class="ui-content widget-content">
							<div style="height:20px;color:red;font:bold 14px arial;text-align: center;">&nbsp;<%if(request.getParameter("failure")!=null) out.print("Invalid Username or password"); %></div>
