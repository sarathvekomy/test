	...
	<div class="first-row" style="width: 820px;">
	    <div class="left-align">
			<div class="number-lable">
			 ...
			 <div class="number">
			<%String dayBookNumber=StringUtil.format(viewResult.getDayBookNo());%>
			<%Integer dayBookId=viewResult.getId();%>
				<span class="property-value"><%=str%>
				<a id="change-request-day-book-number" href="#" class="<%=dayBookNumber%>" align="<%= dayBookId %>"  style="color:#000; font-weight:bold; outline:none;text-decoration:none !important;">
				<%=dayBookNumber %>
				</a>
				</span>
			</div>
		...
		<%-- <div class="right-align">
			<div class="number-lable">
				<span class="span-label">Reporting Manager</span>
			</div>
			<div class="number">
		...
		<div class="left-align">
			...
			<div class="number" style="margin-left:220px;margin-top:-17px;">
				<div class="input-field-preview">
							<%=viewResult.getReasonMiscellaneousExpenses()%>
						</div>
			</div>
		</div>
	</div>
