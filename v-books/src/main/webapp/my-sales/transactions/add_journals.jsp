			...
			<div class="fieldset-row" style="margin-top: 10px;">
				...
				<div class="separator" style="height: 10px;"></div>
					...
					<div id="amount_pop" class="helppop" style="display: block;"
						...
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px;">
							<p>Amount Can Contain Only Numbers and can have only positive values.And Maximum Amount Should be Less Than 10000000000000</p>
						</div>
					</div>
					<div id="amount_len_pop" class="helppop" style="display: block;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px;">
							<p>Maximum Amount Should be Less Than 10000000000000</p>
						</div>
					</div>
					</div>
				</div>
