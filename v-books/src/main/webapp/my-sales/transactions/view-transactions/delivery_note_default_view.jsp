...
%>
				<div id="delivery-note-search-form-container" class="ui-container" title="Search stock">
					...
					<div class="ui-content form-panel form-panel-border">												
						...
						<div id="search-buttons" class="search-buttons">
							<div id="action-search-delivery-note" class="ui-btn btn-search">Search</div>
				...
				<div id="delivery-note-previous-view-dialog-1" style="display: none" title="Delivery Note">
					<div id="delivery-note-previous-view-container-1" style="width:200px;height: 200px"></div>
				</div>
				<div id="delivery-note-previous-view-dialog-2" style="display: none" title="Delivery Note">
					<div id="delivery-note-previous-view-container-2" style="width:200px;height: 200px"></div>
				</div>
				<div id="delivery-note-previous-view-dialog-3" style="display: none" title="Delivery Note">
					<div id="delivery-note-previous-view-container-3" style="width:200px;height: 200px"></div>
				</div>
				<div id="delivery-note-previous-view-dialog-4" style="display: none" title="Delivery Note">
					<div id="delivery-note-previous-view-container-4" style="width:200px;height: 200px"></div>
				</div>
				<div id="delivery-note-previous-view-dialog-5" style="display: none" title="Delivery Note">
					<div id="delivery-note-previous-view-container-5" style="width:200px;height: 200px"></div>
				</div>
