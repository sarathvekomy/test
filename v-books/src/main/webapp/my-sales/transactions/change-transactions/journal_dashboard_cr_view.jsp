...
<%
	...
	vbJournalChangeRequest = changeTransactionDao.getJournalCRById(journalCRId , user.getOrganization(),user.getName());
	if(vbJournalChangeRequest != null){
		vbEmployee=changeTransactionDao.getSalesExecutiveFullName(vbJournalChangeRequest.getCreatedBy(),user.getOrganization());
	}
		}
	} catch (Exception exx) {
		exx.printStackTrace();
...
<div class="outline" style="margin-left: 10px;">
	<div class="first-row">
		<div class="left-align">
			...
			<a id="change-request-journal-Invoice-number" href="#" class="<%=invoiceNumber%>" style="text-decoration: none;">
	...
	<div class="first-row">
	<div class="left-align">
			<div class="number-lable" style="width: 120px; margin-left: -13px;">
