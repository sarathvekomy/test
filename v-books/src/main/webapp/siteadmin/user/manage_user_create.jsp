...
<div id="manage-user-add-form-container" title="Create User">
	...
	<div class="ui-content form-panel full-content">
			...
			<div class="fieldset-row" style="height: 350px; margin-top: 5px;">
				<div class="fieldset" style="height: 30px;">
					<div class="form-row">
						...
						<div class="input-field" id="uName">
							<input class="mandatory constrained" name="username"
								id="username"
				...
				<div class="fieldset" style="height: 50px;">
					<div class="form-row">
						...
						<span id="fnameValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="fname_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
				...
				<div class="label"></div>
					...
					<div class="form-row">
						...
						<span id="alternateValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="alternate_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
								<p><%=Msg.get(MsgEnum.MANAGE_USER_MOBILE) %></p>
						...
						<div id="dbalternate_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
								<p><%=Msg.get(MsgEnum.MANAGE_USER_DB_MOBILE) %></p>
				...
				<div class="fieldset" style="height: 80px;">
					<div class="form-row">
						...
						<span id="dlineValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="dline_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
						...
						<div id="dbdline_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
				...
				<div class="fieldset" style="height: 100px;">
					<div class="form-row">
						...
						<span id="bgroupValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="bgroup_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
						...
						<div id="dbbgroup_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
				...
				<div class="fieldset" style="height: 100px;">
					<div class="form-row">
						...
						<span id="passportValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="passport_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
						...
						<div id="dbpassport_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
					...
					<div class="form-row">
						...
						<span id="nationValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="nation_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
						...
						<div id="dbnation_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
					...
					<div id="page-buttons" class="page-buttons">
						<input name="action" value="manage-user-basic" type="hidden"
							id="manageUserAction">
					</div>
				</div>
			</div>
		</form>
		<form id="manage-user-address-form"	style="height: 280px; display: none;">
			<div class="add-student-tabs">
				<div class="step-no-select">
			...
			<div class="fieldset-row" style="height: 350px; margin-top: 5px;">
				<div class="fieldset" style="height: 100px;">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<select multiple="multiple" name="organizations" style="width:200px;"
								id="organizationType" class="mandatory constrained"
		...
		<div id="page-buttons" class="page-buttons" style="margin-left: 225px; margin-top:60px;" align="center";>
			...
			<button id="button-save" class="ui-btn btn-save" style="display: none;">Save</button>
