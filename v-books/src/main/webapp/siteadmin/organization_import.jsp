<%@page import="com.vekomy.vbooks.util.OrganizationUtils"%>
  ...
  <div id="employee-add-form-container" title="Create employee">
	...
	<div class="ui-content form-panel full-content">
		<form id="organization-upload-form" action="siteadmin/organization_import_submit.jsp" method="post" enctype="multipart/form-data">
  ...
  <script>
  OrganizationHandler.importOrganization();
  </script>