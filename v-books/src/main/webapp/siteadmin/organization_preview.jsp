...
<%@page import="java.util.StringTokenizer"%>
	...
	<div class="add-student-tabs" style="height: 20px; margin-top: 2px;">
		<div class="step-no-select"><div class="step-no-select-corner"></div><div class="tabs-title"><%=Msg.get(MsgEnum.ORGANIZATION_TAB)%></div></div>
		<div class="step-no-select"><div class="step-no-select-corner"></div><div class="tabs-title"><%=Msg.get(MsgEnum.ORGANIZATION_SUPER_USER)%></div></div>
	...
	<div class="table-field" style="height: 75px;">
		...
		<div class="inner-table">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word;"><%=organizationCommand.getMainBranch()%></span>
				</div>			</div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"  Style="padding-left: 2px;word-wrap:break-word;"><%=StringUtil.format(organizationCommand.getMainBranchName())%></span>
				</div>
				</div>
				<div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word;"><%=StringUtil.format(organizationCommand.getCurrencyFormat())%></span>
				</div>
			</div>
			</div>
			</div>
		...
		<div class="display-boxes-colored">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word;"><%=organizationCommand.getOrganizationCode()%></span>
				</div>			</div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"  Style="padding-left: 2px;word-wrap:break-word;"><%=StringUtil.format(organizationCommand.getName())%></span>
				</div>
				</div>
				<div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word;"><%=StringUtil.format(organizationCommand.getBranchName())%></span>
				</div>
			</div>
		</div>
		</div>
		...
		<div class="inner-table">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getAddressLine1())%></span>
				</div>
			</div>
			 <div class="display-boxes-colored" >
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getAddressLine2())%></span>
				</div>
			</div>
			<div class="display-boxes-colored" >
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getLocality())%></span>
				</div>
			</div>
			<div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getLandmark())%></span>
				</div>
			</div>
				<div class="display-boxes-colored">
				<div>
		...
		<div class="inner-table">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getCity())%></span>
				</div>
			</div>
			 <div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationCommand.getState())%></span>
				</div>
			</div>
			 <div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word;"><%=StringUtil.format(organizationCommand.getPhone2())%></span>
				</div>
			</div>
			</div>
			</div>
		...
		<div class="display-boxes-colored">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationSuperUserCommand.getSuperUsername())%></span>
				</div>
			</div>
			<div class="display-boxes-colored" >
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value" Style="padding-left: 2px;word-wrap:break-word"><%=StringUtil.format(organizationSuperUserCommand.getFullName())%></span>
				</div>
			</div>
		...
		<div class="display-boxes-colored">
			...
			<div class="display-boxes" >
				<div>
					<span class="property-value" Style="padding-left: 2px;"><%=StringUtil.format(organizationSuperUserCommand.getAlternateMobile())%></span>
				</div>
			</div>	
			</div></div>
			<div class="main-table">
