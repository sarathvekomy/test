...
<%
	...
	if(mode==null || mode.equals("")) {
		organization = new VbOrganization();
		edit = false;
	}
	try{
...
<div id="organization-create-form-container">
	<div class="green-title-bar">
		<div class="green-title-bar2">
			<div class="page-icon organization-create-icon"></div>
			<div class="page-title organization-create-title"></div>
		</div>
	</div>
	<div class="ui-content form-panel full-content">
	<form id="organization-form"style="height: 340px;">
		<div class="add-student-tabs">
				<div class="step-selected">
					<div class="tabs-title" style="padding-left: 10px;"><%=Msg.get(MsgEnum.ORGANIZATION_TAB)%>
					</div>
				</div>
				<div class="step-no-select"style="width:190px;">
			...
			<div class="fieldset-row" style="height: 280px; margin-top:-5px;">
				...
				<div class="form-row">
											...
											<div class="input-field">
												...
												<option value="<%=organization.getMainBranch()%>"><%=DropDownUtil.getDropDown(DropDownUtil.MAIN_BRANCH).get(organization.getMainBranch())%></option>
												<%													
													for(String mainBranch: DropDownUtil.getDropDown(DropDownUtil.MAIN_BRANCH).keySet()) {
														if(mainBranch.equalsIgnoreCase(organization.getMainBranch()))
															continue;
													%>
													
												<option value="<%=mainBranch %>"><%=DropDownUtil.getDropDown(DropDownUtil.MAIN_BRANCH, mainBranch) %></option>
												<%} %>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="mainBranchName" id="mainBranchName" disabled="disabled">
						</div>
						<div id="branchMainPop" class="helppop" style="display: block;" aria-hidden="false">
				...
				<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="organizationCode" id="organizationCode"value="<%=organization.getOrganizationCode()%>">
						</div>
						<span id="organizationCodeValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="namehelp_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Organization Code can contain letters, numbers, at the rate(@), hash(#), curlybraces(()), dashes(-), Underscore(_),
									slash(/) and spaces.</p>
							</div>
						</div>
						<div id="codedb_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Organization Code can not exceed 30 characters.</p>
							</div>
						</div>
						<div id="code_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="name" id="name"value="<%=organization.getName()%>">
						</div>
						<span id="organizationNameValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="organizationName_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Organization Name can contain letters, numbers, at the rate(@), hash(#), curlybraces(()), dashes(-), Underscore(_),
									slash(/) and spaces.</p>
							</div>
						</div>
						<div id="dbName_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Organization Name can not accepts more than 400 characters.</p>
							</div>
						</div>
					</div>
					</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="currencyFormat" id="currencyFormat" class="mandatory" value="<%=organization.getCurrencyFormat()%>">
						</div>
						<span id="currencyValid"	style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="currency_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="branchName" id="branchName" value="<%=organization.getBranchName()%>">
						</div>
						<span id="branchNameValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="branchName_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Branch Name can contain letters, numbers, at the rate(@), hash(#), curlybraces(()), dashes(-), Underscore(_), slash(/)
									and spaces.</p>
							</div>
						</div>
						<div id="dbBranchName_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
					...
					<div class="fieldset" style="height: 30px;">
						...
						<div class="input-field">
							<input class="mandatory" name="addressLine1" id="addressLine1" value="<%=organization.getAddressLine1() %>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="addressLine2" id="addressLine2"value="<%= organization.getAddressLine2()%>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="locality" id="locality" value="<%=organization.getLocality() %>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="landmark" id="landmark" value="<%=organization.getLandmark() %>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="city" id="city" value="<%=organization.getCity() %>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="state" id="state" value="<%= organization.getState()%>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="country" id="country" value="<%=organization.getCountry() %>">
						</div>
						<span id="countryValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="country_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Country accepts alphabetics, spaces( ) and periods(.) only.</p>
							</div>
						</div>
						<div id="dbCountry_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr"	style="float: left; margin-left: 3px;">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="zipcode" id="zipcode" value="<%=organization.getZipcode()%>">
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="phone1" id="phone1" value="<%=organization.getPhone1()%>">
						</div>
						<span id="phone1Valid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="phone1_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Phone 1 can contains numbers, spaces, hyphen(-) and curly
									braces(()) and should not exceed more than twenty characters.</p>
							</div>
						</div>
						<div id="dbPhone1_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
					...
					<div class="separator" style="height: 110px; margin-left:100px;"></div>
					<div class="fieldset" style="height: 40px">
					<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.ORGANIZATION_PHONE2_LABEL) %></div>
						<div class="input-field">
							<input name="phone2" id="phone2" value="<%=organization.getPhone2()%>">
						</div>
						<span id="phone2Valid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="phone2_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Phone 2 can contains numbers, spaces, hyphen(-) and curly
									braces(()) and should not exceed more than twenty characters.</p>
							</div>
						</div>
						<div id="dbPhone2_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
					...
					<div class="fieldset" style="height: 40px">
					<div class="form-row">
						<div class="label" style="margin-left: -380px;"><%=Msg.get(MsgEnum.ORGANIZATION_DESCRIPTION_LABEL) %></div>
						<div class="input-field">
							<textarea name="description" id="description" rows="3" cols="50" style="margin-left: -255px;"><%=organization.getDescription() %></textarea>
						</div>
						<span id="descriptionValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="dbdescription_pop" class="helppop" style="display: block;"	aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
				...
				<form id="organization-superuser-form" style="display: none;height:220px;">
				<div class="add-student-tabs">
				<div class="step-no-select">
					<div class="tabs-title"><%=Msg.get(MsgEnum.ORGANIZATION_TAB)%>
					</div>
				</div>
				<div class="step-selected"style="width:190px;">
					<div class="step-no-select-corner"></div>
				...
				<div class="fieldset" style="height:20px;">
				<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.ORGANIZATION_FULL_NAME_LABEL) %> </div>
						<div class="input-field">
							<input class="mandatory" name="fullName" id="fullName" value="<%=organization.getFullName()%>"> 
						</div>
						<span id="fillNameValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="fullName_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Full Name can contain letters, numbers, periods (.) and at the rate (@) and spaces.</p>
							</div>
						</div>
				...
				<div class="form-row">
						...
						<div class="input-field" id="uName">
							<input class="mandatory constrained"
								constraints='{"fieldLabel":"username","charsNumsNoSpace":"true"}'
								name="superUsername" id="username"value="<%=organization.getSuperUserName()%>">
						</div>
						<span id="uValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<span id="unValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="username_pop" class="helppop" style="display: block;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px;">
								<p>Username can contain letters, numbers, periods (.) and
									underscores (_).</p>
							</div>
						</div>
					</div>
				...
				<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="mobile" id="mobile" value="<%=organization.getPhone1()%>">
						</div>
						<span id="mobileValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="alternateMobile"id="alternateMobile" value="<%=organization.getPhone2()%>">
						</div>
				...
				<div class="fieldset" style="height: 40px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="email" id="email"value="<%=organization.getEmail()%>">
						</div>
			...
			<input name="id" value="<%=organization.getId()%>" type="hidden"
				id="organizationId">
			<input name="action" value="save-super-organization" type="hidden" id="organizationAction">
				</form>
			
			
		<div id="organization-user-preview-container" style="display: none;"></div>
		<div id="page-buttons" class="page-buttons"
			style="margin-left: 200px; margin-top: 35px;">
			
			<div id="button-prev" class="ui-btn btn-prev" style="display: none"></div>
			<div id="action-update" class="ui-btn btn-update"style="display: none;"></div>
			...
			<div id="action-cancel" class="ui-btn btn-cancel"></div>
					 ...
					 <div id="organization-code-suggestions" style="display:none;position: absolute;" class="timetable-teacher-suggestions">
						<img id="exposeMask_loading_img" src="images/common/ajax-loader.gif" alt="loading.."
