		...
		<div class="add-student-tabs">
			...
			<div class="fieldset-row" style="height: 320px; margin-top:-5px;">
				...
				<div class="fieldset" style="height: 20px;">
					...
					<div class="label" style="width:125px; !important;"><%=Msg.get(MsgEnum.EMPLOYEE_USERNAME)%>
					</div>
					<div class="input-field" id="uName" style="">
						<input style="width: auto; text-align: left;" class="read-only" id="orgPrefix" name="orgPrefix"
