...
<%
	...
	try {
		...
		SiteAdminDao siteadminDao = (SiteAdminDao) hibernateContext
				.getBean("siteadminDao");
	} catch (Exception e) {
...
<div id="organization-create-form-container">
	...
	<form id="organization-form"style="height: 335px;">
			...
			<div class="fieldset-row" style="height: 320px; margin-top:-5px;">
				...
				<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<textarea name="description" id="description" rows="3" cols="50" style="margin-left: -255px;"></textarea>
						</div>
				...
				<div class="form-row">
						...
						<div class="input-field" id="uName">
							<input class="mandatory constrained" constraints='{"fieldLabel":"username","charsNumsNoSpace":"true"}' name="superUsername" id="username">
						</div>
						...
						<div id="username_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>Username can contain letters, numbers, periods (.) and underscores (_).</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="page-buttons" class="page-buttons"	style="margin-left: 200px; margin-top: 35px;">
				
			<div id="button-prev" class="ui-btn btn-prev" style="display: none"></div>
			<div id="action-save" class="ui-btn btn-save" style="display: none;"></div>
