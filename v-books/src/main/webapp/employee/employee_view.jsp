...
<%
	...
	if(viewType!=null && viewType.equals("preview")) {
		preview = true;
		employee = (EmployeeCommand) session.getAttribute("employee-basic");
		employeeDetail = (VbEmployeeDetail) session.getAttribute("employee-detail");
		employeeAddress = (VbEmployeeAddress)session.getAttribute("employee-address");
    	...
    	try{
	    	...
	    	if(employeeDao!=null) {
	    		...
	    		Iterator<VbEmployeeDetail> iterator = employee.getVbEmployeeDetails().iterator();
	    		if(iterator.hasNext()) {
	    			employeeDetail = iterator.next(); 
	    		}
	    		Iterator<VbEmployeeAddress> iterator_address = employee.getVbEmployeeAddresses().iterator();
