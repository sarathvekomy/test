...
<%@page import="java.util.StringTokenizer"%>
	...
	<%} %>
		...
		<% if (list != null) { %>
			<div class="invoice-main-table" style="width: 461px !important;border-top:solid 1px gray;margin:25px;">
		<div class="inner-table" style="width: 461px !important;">
			...
			<div class="result-row" id="row-<%=count%>" style="width: 460px !important;">
				...
				<div class="invoice-boxes invoice-boxes-<%=count%>" Style="width: 135px; border-right:none !important;">
					<div>
