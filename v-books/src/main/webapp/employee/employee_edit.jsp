...
<%
	...
	try {
		...
		if (employeeDao != null) {
			...
			vbEmployee = employeeDao.getEmployee(id , user.getOrganization());
...
<div id="employee-add-form-container" title="Create Employee">
						...
						<form id="employee-form" style="height: 280px;">
						...
						<input type="hidden" name="id" value="<%=vbEmployee.getId()%>">
							<div class="fieldset-row" style="margin-top: 10px;">
								<div class="form-row" style="margin-bottom:30px;">
									...
									<div class="input-field" id="uName"><input class="remove-inputfield-style mandatory"  readonly="readonly" value="<%=StringUtil.format(vbEmployee.getUsername())%>" class="mandatory constrained" constraints='{"fieldLabel":"Username","maxSize":"30"}' name="username" id="userName" ></div>
								...
								<div class="form-row" style="margin-bottom:30px; margin-left: 10px;">
									<div class="form-row">
										<div class="label"><%=Msg.get(MsgEnum.EMPLOYEE_EMPLOYEE_NO_LABEL)%></div>
										 <div class="input-field"><input  class="remove-inputfield-style mandatory" style =" background-color:inherit;border :0 none ;font-weight:bold;" readonly="readonly" value="<%=vbEmployee.getEmployeeNumber()%>" class="mandatory constrained" constraints='{"fieldLabel":"Employee Number","maxSize":"10","numbersOnly":"true"}' name="employeeNumber" id="employeeNumber" ></div>
									</div>
								</div>
							</div>
							<div class="fieldset-row" style="margin-top: 10px;">
								<div class="fieldset" style="height: 120px;">
									<div class="form-row">
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployee.getFirstName())%>" class="mandatory" name="firstName" id="firstName" ></div>
									...
									<div class="form-row">
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployee.getMiddleName())%>" name="middleName" id="middleName" ></div>
									...
									<div class="form-row">
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployee.getLastName())%>" class="mandatory" name="lastName" id="lastName" ></div>
								...
								<div class="fieldset" style="height: 120px;">
									<div class="form-row">
										<div class="label"><%=Msg.get(MsgEnum.EMPLOYEE_EID_LABLE)%></div>
										 <div class="input-field"><input class="mandatory constrained" constraints='{"fieldLabel":"Email","email":"true"}'value="<%=StringUtil.format(vbEmployee.getEmployeeEmail())%>" name="employeeEmail" id="employeeEmail"  class="constrained" constraints='{"fieldLabel":"Employee","email":"true"}'></div>
									...
									<div class="form-row">
										...
										<div class="input-field"> 
											...
											<option value="<%=vbEmployee.getEmployeeType()%>"><%=DropDownUtil.getDropDown(DropDownUtil.EMPLOYEE_TYPE).get(vbEmployee.getEmployeeType())%></option>
												<%													
													for(String employeeType: DropDownUtil.getDropDown(DropDownUtil.EMPLOYEE_TYPE).keySet()) {
														if(employeeType.equalsIgnoreCase(vbEmployee.getEmployeeType()))
															continue;
													%>
						...
						<form id="employee-detail-form" style="height:280px; display:none;">
							<div class="add-student-tabs">
							...
							<div class="fieldset-row" style="margin-top: 10px;">
								<div class="fieldset" style="height: 150px;">
									<div class="form-row">
										 ...
										 <div class="input-field"><input value="<%=vbEmployeeDetail.getMobile()%>" class="mandatory constrained" constraints='{"fieldLabel":"Mobile Number","numbersOnly":"true"}' name="mobile" id="mobile" ></div>
									...
									<div class="form-row"> 
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployeeDetail.getDirectLine())%>"class="constrained" constraints='{"fieldLabel":"Residence Phone","residence":"true"}'  name="directLine" id="directLine" ></div>
							 	...
							 	<div class="form-row"> 
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployeeDetail.getAlternateMobile())%>" class="constrained" constraints='{"fieldLabel":"Residence Phone","residence":"true"}'  name="alternateMobile" id="alternateMobile" ></div>
								...
								<div class="fieldset" style="height: 150px;">
								 <div class="form-row">
										 ...
										 <div class="input-field"><input value="<%=StringUtil.format(vbEmployeeDetail.getBloodGroup())%>" class="mandatory" name="bloodGroup" id="bloodGroup" ></div>
									...
									<div class="form-row">
										...
										<div class="input-field"><input  value="<%=StringUtil.format(vbEmployeeDetail.getPassportNumber())%>" class="mandatory" name="passportNumber" id="passPortNumber" ></div>
									...
									<div class="form-row">
										...
										<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeDetail.getNationality())%>" class="mandatory" name="nationality" id="nationality" ></div>
						...
						<form id="employee-address-form" style="height: 280px; display:none;">
							<div class="add-student-tabs">
								<div class="step-no-select"><div class="tabs-title"><%=Msg.get(MsgEnum.EMPLOYEE_BASIC_INFO_LABEL)%> </div></div>
							...
							<div class="fieldset-row" style="margin-top: 10px;">
								<div class="fieldset" style="height: 150px;">
									<div class="form-row">
										...
										<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getAddressLine1())%>" class="mandatory" name="addressLine1" id="addressLine1" ></div>
									...
									<div class="form-row">
										...
										<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getAddressLine2())%>" name="addressLine2" id="addressLine2" ></div>
									...
									<div class="form-row">
										...
										<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getLocality())%>" class="mandatory" name="locality" id="locality" ></div>
									...
									<div class="form-row">
										...
										<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getLandmark())%>" name="landmark" id="landmark" ></div>
						...
						<div class="fieldset" style="height: 150px;">
							<div class="form-row">
								...
								<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getCity())%>" class="mandatory" name="city" id="city" ></div>
							...
							<div class="form-row">
								...
								<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getState())%>" class="mandatory" name="state" id="state" ></div>
							...
							<div class="form-row">
								...
								<div class="input-field"><input value="<%=StringUtil.format(vbEmployeeAddress.getZipcode())%>" class="mandatory"  name="zipcode" id="zipcode" ></div>
							...
							<select class="mandatory" name="addressType" id="addressTypeEdit">
							 <option selected="selected"><%=StringUtil.format(vbEmployeeAddress.getAddressType())%></option>
							</select>
						</div>
						...
						<div id="page-buttons" class="page-buttons" style="margin-left: 200px; margin-top: 10px;">
							...
							<div id="button-update-employee" class="ui-btn btn-update" style="display: none;"></div>
							<div id="action-clear" class="ui-btn btn-clear"></div>							
							<div id="action-cancel-edit" class="ui-btn btn-cancel"></div>
						</div>	
					</div>
					</div>
