...
<div id="customer-add-form-container" title="Create Customer"></div>
<div class="ui-content form-panel full-content">
	<form id="customer-form" style="height: 335px;">
		...
		<div class="fieldset-row" style="margin-top: 10px;">
			<div class="form-row" style="margin-bottom: 30px;">
				...
				<div id="businessnamevalid_pop" class="helppop"
				...
				<div id="businessnamelen_pop" class="helppop"
					style="display: block;" aria-hidden="false">
					<div id="namehelp" class="helpctr"
						style="float: left; margin-left: 3px;">
			...
			<div class="form-row" style="margin-bottom: 30px; margin-left: 50px;">
				...
				<div id="iname_pop" class="helppop"
					...
					<div id="namehelp" class="helpctr"
						...
						<p><%=Msg.get(MsgEnum.VALIDATE_INVOICE_NAME)%></p>
					</div>
				</div>
				<div id="inamelen_pop" class="helppop"
					style="display: block; margin-top: -5px;" aria-hidden="false">
					<div id="namehelp" class="helpctr"
						style="float: left; margin-left: 3px; margin-top: 2px;">
						<p><%=Msg.get(MsgEnum.INVOICE_NAME_VALIDATION)%></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="fieldset" style="height: 40px;">
				<div class="form-row">
					...
					<span id="customerNameValid"
						style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					<div id="cname_pop" class="helppop"
				...
				<div class="form-row">
					...
					<div class="input-field" style="width: 43px; ">
						<input id="male" type="radio" name="gender" class="gender "
							checked="checked" value="M" style="width: 13px; height:13px;border: 0 !important;" /> <span
							class="male"><%=Msg.get(MsgEnum.EMPLOYEE_GENDER_MALE_LABLE)%></span>
					</div>
					<div class="input-field" style="width: 43px; ">
						<input id="female" type="radio" name="gender" class="gender "
							value="F" style="width: 13px; height:13px;border: 0 !important;" /> <span class="female"><%=Msg.get(MsgEnum.EMPLOYEE_GENDER_FEMALE_LABLE)%></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="fieldset-row" style="margin-top: 20px;">
			<div class="form-row">
				...
				<div class="input-field">
					...
					<div id="mobilelen_pop" class="helppop"
						style="display: block; float: left; margin-left: 140px; margin-top: -25px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px; margin-top: 2px;">
		...
		<div class="fieldset" style="height: 60px;">
			<div class="form-row">
				...
				<div class="input-field">
					...
					<div id="emaillen_pop" class="helppop"
						style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px; margin-top: 2px;"">
		...
		<div class="fieldset" style="height: 20px;">
			<div class="form-row">
				...
				<div class="input-field">
					<input name="creditLimit" id="creditLimit" class = "mandatory"> <span
						id="creditLimitValid"
						style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
					<div id="creditlimit_pop" class="helppop"
						style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px; margin-top: 2px;">
					...
					<div id="creditlimitlen_pop" class="helppop"
						style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px; margin-top: 2px;">
		...
		<div class="fieldset" style="height: 20px;">
			<div class="form-row">
				...
				<div class="input-field">
					<input name="creditOverdueDays" id="creditOverdueDays" class = "mandatory"> <span
						id="overduesValid"
						style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
					<div id="overdues_pop" class="helppop"
						style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
					...
					<div id="overdueslen_pop" class="helppop"
						style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px; margin-top: -5px;">
		...
		<div class="fieldset-row" style="margin-top: 10px;">
				...
				<div class="form-row">
					...
					<div class="input-field">
						...
						<div id="dline_pop" class="helppop"
							...
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: -5px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_DIRECT_LINE)%></p>
							</div>
						</div>
						<div id="dlinelen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: -5px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_DIRECT_LINE_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input name="alternateMobile" id="alternateMobile"> <span
							id="altmobileValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
						<div id="alternate_pop" class="helppop"
							...
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ALTERNATE_MOBILE)%></p>
							</div>
						</div>
						<div id="alternatelen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ALTERNATE_MOBILE_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						...
						<span id="addressLine1Valid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
						<div id="addressLine1_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ADDRESS1)%></p>
							</div>
						</div>
						<div id="addressLine1len_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ADDRESS1_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="input-field">
						<input name="addressLine2" id="addressLine2"> <span
							id="address2Valid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
						<div id="addressLine2_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ADDRESS2)%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="input-field">
						...
						<div id="locality_pop" class="helppop"
							...
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_LOCALITY)%></p>
							</div>
						</div>
						<div id="localitylen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_LOCALITY_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="input-field">
						...
						<div id="landmark_pop" class="helppop"
							...
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_LANDMARK)%></p>
							</div>
						</div>
						<div id="landmarklen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_LANDMARK_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="fieldset" style="height: 60px;">
				...
				<div class="form-row">
					...
					<div class="input-field">
						...
						<div id="state_pop" class="helppop"
							...
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_STATE)%></p>
							</div>
						</div>
						<div id="statelen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_STATE_CHAR)%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="input-field">
						...
						<div id="citylen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_CITY_CHARS)%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="input-field">
						<input name="zipcode" id="zipcode"> <span
							id="zipcodeValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
						<div id="pincode_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ZIPCODE)%></p>
							</div>
						</div>
						<div id="pincodelen_pop" class="helppop"
							style="display: block; margin-top: -25px; float: left; margin-left: 140px;"
							aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
								<p><%=Msg.get(MsgEnum.VALIDATE_ZIPCODE_CHARS)%></p>
							</div>
						</div>
					</div>
				</div>
	...
	<div id="page-buttons" class="page-buttons"
		style="margin-left: 180px; margin-top: 60px;" align="center">
