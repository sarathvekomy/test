...
<%
	...
	try {
		...
		if (customerDao != null) {
			...
			Iterator iterator = vbCustomer.getVbCustomerDetails()
					.iterator();

			if (iterator.hasNext()) {
				vbCustomerDetail = (VbCustomerDetail) iterator.next();
			}
			if (vbCustomerDetail == null) {
				vbCustomerDetail = new VbCustomerDetail();
			}
		}
	} catch (Exception exx) {
		exx.printStackTrace();
...
<div class="ui-content form-panel full-content">
	<form id="customer-form" style="height: 280px;">
		...
		<div class="fieldset-row" style="margin-top: 10px;">
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="form-row" style="margin-bottom: 30px;">
					...
					<div class="input-field" id="bName">
						<input class="mandatory constrained" name="businessName"
							...
							value="<%=StringUtil.format(vbCustomer.getBusinessName())%>">
					</div>
				...
				<div class="form-row" style="margin-bottom:30px;margin-left:50px;">
									...
									<div class="input-field" ><input class="mandatory" name="invoiceName" id="invoiceName"
									value="<%=StringUtil.format(vbCustomer.getInvoiceName())%>"></div>
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height:40px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory constrained" name="customerName"
								...
								value="<%=StringUtil.format(vbCustomer.getCustomerName())%>">
						</div>
					...
					<div class="form-row">
						...
						<%
							if (vbCustomer.getGender().equals('M')) {
						%>
						...
						%>
						<%
							if (vbCustomer.getGender().equals('F')) {
						%>
						<div class="input-field" style="width: 43px;">
							<input id="male" type="radio" name="gender" class="gender "
								value="M" style="width: 20px;" /><span class="male"><%=Msg.get(MsgEnum.CUSTOMER_GENDER_MALE_LABLE)%></span>
						</div>
						<div class="input-field" style="width: 43px;">
							<input id="female" type="radio" name="gender" class="gender "
								checked="checked" value="F" style="width: 20px;" /><span
								class="female"><%=Msg.get(MsgEnum.CUSTOMER_GENDER_FEMALE_LABLE)%></span>
						</div>
						<%
							}
						%>
			...
			<div class="fieldset-row" style="margin-top:20px;">
					<div class="form-row">
						...
						<div class="input-field">
							...
							name="mobile" id="mobile" value="<%=StringUtil.format(vbCustomerDetail.getMobile())%>"> <span id="mobileValid"
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input  name="email" id="Email"
							constraints='{"fieldLabel":"Email Id","email":"true"}'value="<%=StringUtil.format(vbCustomerDetail.getEmail())%>"> <span
							id="emailValid"
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input
							...
							name="creditLimit" id="creditLimit"value="<%=StringUtil.format(vbCustomer.getCreditLimit())%>"> <span
							id="creditLimitValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
			...
			<div class="fieldset" style="height: 20px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input 	constraints='{"fieldLabel":"creditOverDueDays","numbersOnly":"true"}'
							name="creditOverdueDays" id="creditOverdueDays" 
							value="<%=StringUtil.nullFormat(vbCustomer.getCreditOverdueDays())%>"> <span
							id="overduesValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
		...
		<input name="id" id="id" value="<%=vbCustomer.getId()%>" type="hidden">
	</form>
		...
		<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input name="directLine" id="directLine" 
							...
							value="<%=StringUtil.format(vbCustomerDetail.getDirectLine())%>">
			...
			<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input name="alternateMobile" id="alternateMobile"  value="<%=StringUtil.format(vbCustomerDetail.getAlternateMobile())%>">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="addressLine1" id="addressLine1" maxlength="45"
							value="<%=StringUtil.format(vbCustomerDetail.getAddressLine1())%>">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="addressLine2" id="addressLine2" 
							value="<%=StringUtil.format(vbCustomerDetail.getAddressLine2())%>">
					</div>
					<span id="address2Valid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: -2px"></span>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input class="mandatory constrained" name="locality" id="locality"
							...
							value="<%=StringUtil.format(vbCustomerDetail.getLocality())%>">
            ...
            <div id="localitylen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="landmark" id="landmark" value="<%=StringUtil.format(vbCustomerDetail.getLandmark()) %>"> <span
							id="landmarkValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
							<div id="landmark_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
                <div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;margin-top:2px;"><p>L<%=Msg.get(MsgEnum.VALIDATE_LANDMARK) %></p></div>
            </div>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input class="mandatory constrained" name="region" id="region"
							...
							constraints='{"fieldLabel":"region","charsOnly":"true"}'value="<%=StringUtil.format(vbCustomerDetail.getRegion())%>">
						<span id="regionValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input  name="state" id="state"
							...
							constraints='{"fieldLabel":"state","charsOnly":"true"}'value="<%=StringUtil.format(vbCustomerDetail.getState())%>">
						<span id="stateValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="city" id="city"
							...
							constraints='{"fieldLabel":"city","charsOnly":"true"}' value="<%=StringUtil.format(vbCustomerDetail.getCity())%>"> <span
							id="cityValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
            ...
            <div id="citylen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input   
							name="zipcode"
							id="zipcode"value="<%=StringUtil.format(vbCustomerDetail.getZipcode())%>"> <span id="zipcodeValid"
							style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
