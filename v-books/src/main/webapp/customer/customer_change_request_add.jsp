...
<div class="ui-content form-panel full-content">
			...
			<div class="form-row" style="margin-bottom: 30px;">
				...
				<div id="businessName_pop" class="helppop" style="display: block;"
					...
					<div id="namehelp" class="helpctr"
						...
						<p>Business Name can have only letters, numbers, Spaces</p>
					</div>
				</div>
				<div id="businessnamelen_pop" class="helppop" style="display: block;"
						...
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px;">
							<p>Business should not exceed 200 characters</p>
						</div>
					</div>
			</div>
			</div>
	...
	<div id="page-buttons" class="page-buttons"
		...
		<div id="button-cr-prev" class="ui-btn btn-prev" style="display: none"></div>
		<div id="button-cr-next" class="ui-btn btn-next"></div>
