				 ...
				 <div class="fieldset-row" style="margin-top: 10px;">
					...
					<div class="form-row" style="margin-bottom: 10px;">
						...
						<div class="form-row" style="margin-bottom: 10px;">
							...
							<div class="input-field">
								<input name="qtyClosingBalance" id="qtyClosingBalance" class="qtyClosingBalance" readonly="readonly" style="border: none; background-color:inherit; text-align:left !important;" value="<%=salesBookProducts.getQtyClosingBalance()%>">
							</div>
						</div>
						<div class="form-row" style="margin-bottom: 10px;">
							<div class="label"><%=Msg.get(MsgEnum.ACCOUNTS_AVAILABLE_QUANTITY_LABEL)%></div>
							<div class="input-field">
								<input name="availableQuantity" id="availableQuantity" readonly="readonly" style="border: none; background-color:inherit;text-align:left !important;" value="<%=availableQty%>">
							</div>
						</div>
						<div class="form-row" style="margin-bottom: 10px;">
							<div class="label"><%=Msg.get(MsgEnum.ACCOUNTS_ALLOTMENT_LABEL)%></div>
							<div class="input-field">
								<input name="qtyAllotted"  class="mandatory qtyAllotted" id="qtyAllotted" value="<%=salesBookProducts.getRecentAllotment()%>">
							</div>
						</div>
						<div class="form-row" style="margin-bottom: 10px;">
							<div class="label"><%=Msg.get(MsgEnum.ACCOUNTS_OPENING_STOCK_LABEL)%></div>
							<div class="input-field">
								<input class="qtyOpeningBal" name="qtyOpeningBalance" id="qtyOpeningBal" readonly="readonly" style="border: none; background-color:inherit;text-align:left !important;" value="<%=salesBookProducts.getQtyOpeningBalance()%>">
							</div>
						</div>
						 <div class="form-row">
							...
							<textarea rows="3" cols="40" name="remarks" id="remarks" class="remarks" style="resize: none;" ><%=" "%></textarea>
							<%} else {%>
								<textarea rows="3" cols="40" name="remarks" id="remarks" class="remarks" style="resize: none;"><%=salesBookProducts.getRemarks()%></textarea>
									<%} %>
							</div>
						</div> 
