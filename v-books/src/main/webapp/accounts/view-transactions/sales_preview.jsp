...
<div class="main-table"
		...
		<div class="inner-table" style="width: 330px;">
			...
			<%for(int i=0;i<list.size();i++)
			{
				...
				<%if(StringUtil.nullFormat(product.getQtyAllotted())!= ""){ %>
				<%qtyAlloted = qtyAlloted + product.getQtyAllotted(); %>				
				<%} %>
				
			<%} %>
				<% if (list != null&&!list.isEmpty()) { %>
			<%if(qtyAlloted != 0){%>
 			<div style="width:965px; float:left;" id="titles-row">
 			<table  border="1" width="100%">
 		      <tr id="titles"><td>S.No</td><td>Product Name</td><td>Batch No</td><td>Previous Closing Stock</td><td>Quantity Allotted</td><td>Quantity Opening Balance</td><td>Quantity Sold</td>
