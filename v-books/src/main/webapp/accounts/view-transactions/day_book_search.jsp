...
%>
				<div id="day-book-search-form-container" class="ui-container" title="Search stock">
					<div class="ui-content form-panel form-panel-border">												
						...
						<div id="search-buttons" class="search-buttons">
							<div id="action-search-day-book" class="ui-btn btn-search"></div>
				...
				$(document).ready(function() {
					SalesBookHandler.initSearchDayBookOnLoad();
				...
				SalesBookHandler.initSearchDayBook(<%=user.getRoles().contains("ROLE_MANAGEMENT")%>);
				</script>									