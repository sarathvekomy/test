	...
	<div class="first-row">
		...
		<div class="right-align">
			...
			<div class="number" style="margin-left:110px;">
				<span class="property-value"><%=str%><%=DateUtils.format(vbDeliveryNote.getCreatedDate())%></span>
			</div>
		</div>
	</div>
	...
	<div class="invoice-main-table" style="overflow:hidden;">
		<div class="inner-table" style="width: 1000px;">
			...
			<%
				...
				{
				count++;
				DeliveryNoteViewResult product=resultList.get(i);
			%>
			<%
				String reason=StringUtil.format(product.getBonusReason());
			 String batchNo=StringUtil.format(product.getBatchNumber());
			 String productName=StringUtil.format(product.getProduct());
				if(productName.length()>25||reason.length()>25||batchNo.length()>8){
			...
			<div class="result-row" id="row-<%=count%>">
				...
				<div class="invoice-boxes invoice-boxes-<%=count%>" Style="width: 145px;">
					<div>
						<span class="property"><%=StringUtil.format(productName)%></span>
					</div>
				</div>
		...
		<div class="paymentset">
			<div class="form-row">
				...
				<div class="input-field"><span class="appostaphie"><%=str%></span>
					<span class="span-payment"><%=StringUtil.currencyFormat(vbDeliveryNote
