...
<%@page import="com.vekomy.vbooks.util.DropDownUtil"%>
				...
				<div id="search-results-container2" class="ui-container search-results-container" style="overflow: hidden">
					<div class="ui-content">
						<div id="search-results-list" class="green-results-list" style="height: 300px;overflow: hidden"></div>
						<div class="green-footer-bar"></div>
					</div>
				</div>
				<div id="alert-delete-dialog" style="display: none;" title="Edit Alert Details">
					<div id="alert-delete-container"></div>
				</div>
				<div id="alert-view-dialog" style="display: none;" title="View Alert Details">
