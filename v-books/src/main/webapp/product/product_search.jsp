...
<div id="product-search-form-container" class="ui-container"
	...
	<div class="green-title-bar">
		<div class="green-title-bar2">
			<div  id="action-add-product-transaction" style="float:right; cursor: pointer;"></div> 
			<div  id="action-add-arrived-quantity" style="float:right; cursor: pointer;"></div> 
			<div  id="action-add-product" style="float: right; cursor: pointer;"></div>
		</div>
	</div>
	<div class="ui-content form-panel form-panel-border">
		...
		<div id="search-buttons" class="search-buttons">
			<div id="action-search-product-list" class="ui-btn btn-search"></div>
...
<div id="search-results-container2"
    ...
    <div class="ui-content">
		<div id="search-results-list" class="green-results-list"
			style="height: 315px; overflow: hidden;"></div>
