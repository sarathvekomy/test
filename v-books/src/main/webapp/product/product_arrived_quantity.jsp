...
<div id="product-arrived-quantity-form-container" title="Save Arrived Quantity" align="center" style="padding-top: 50px;">
	 ...
	 <div class="report-header" style="width: 420px; height: 30px;"> 
				...
				<div class="report-header-column2 centered" style="width: 140px;">Arrived Quantity</div>
	 </div> 
	<%
	int count=0;
	 ...
	 %>
	 <div class="report-body" id="arrived-product" style="width: 420px; height: auto; overflow: hidden;">
	    <div class="productNumber">
					<div class="report-body-column2 centered sameheightcolumns" id="productName" style="height: auto; width: 120px; word-wrap: break-word;"><%=productList.get(i).getProductName() %></div>
					<div class="report-body-column2 centered sameheightcolumns" id="batchNumber" style="height: auto; width: 120px; word-wrap: break-word;"><%=productList.get(i).getBatchNumber()%></div>
					<div class="report-body-column2 centered sameheightcolumns" style="height: auto; width: 90px;"> 
					<div class="input-field" id="quantityArrived">
								<input name="qunatityArrived" id="qunatityArrived" value="<%=new Integer(0) %>" style="height: 16px; width: 100px; padding-left: 10px; border: 0px;">
	 ...
	 <div class="report-body" id="arrived-product" style="width: 420px; height: auto; overflow: hidden;">
	    <div class="productNumber">
					<div class="report-body-column2 centered sameheight" id="productName" style="height: auto; width: 120px; word-wrap: break-word;"><%=productList.get(i).getProductName() %></div>
					<div class="report-body-column2 centered sameheight" id="batchNumber" style="height: auto; width: 120px; word-wrap: break-word;"><%=productList.get(i).getBatchNumber()%></div>
	...
	<div class="report-body" id="arrived-product" style="width: 420px; height: 30px;">
	   <div class="productNumber">
					...
					<div class="report-body-column2 centered" style="height: 21px; width: 90px;"> 
					<div class="input-field">
								<input name="qunatityArrived" id="qunatityArrived"  class="right-aligned" value="<%=new Integer(0) %>" style="height: 16px; width: 100px; padding-left: 10px; border: 0px;">
							    <span id="arrivedQuantity-<%=count++%>" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					</div>
					</div>
					</div>
