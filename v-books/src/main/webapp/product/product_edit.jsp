...
%>
<div id="product-edit-form-container" title="Create Product">
			...
			<form id="product-edit-form" style="height: 280px;">
				 <div class="fieldset-row" style="margin-top: 10px;">
					...
					<div class="form-row" style="margin-bottom: 10px;">
							...
							<input type="hidden" value="<%=id%>" id="idPrd">
							<%
							if(vbProduct.getProductCategory()==null){
							%>
							<div class="input-field">
								<select name="productCategory" id="productCategoryName">
							...
							<span id="productCategoryValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
							 <div id="productCategory_pop" class="helppop" style="display: block;" aria-hidden="false">
                                 <div id="namehelp" class="helpctr" style="float: left; margin-left: 5px; width: 110px;font-size:12px;"><p style="display: inline;"> Product Category can contain letters, numbers and space.</p></div>
                            </div> 
							<%
							}else{
							%>
							<div class="input-field">
								<select name="productCategory" id="productCategoryName">
								<option value="<%=vbProduct.getProductCategory()%>"selected="selected"><%=vbProduct.getProductCategory()%></option>
								</select>
							</div>
							<span id="productCategoryValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
							 <div id="productCategory_pop" class="helppop" style="display: block;" aria-hidden="false">
						...
						<div class="form-row" style="margin-bottom: 10px;">
							...
							<span id="productBrandValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
							 <div id="productBrand_pop" class="helppop" style="display: block;" aria-hidden="false">
                                 <div id="namehelp" class="helpctr" style="float: left; margin-left: 5px; width: 110px;font-size:12px;">Product Brand can contain letters, numbers and space.</div>
                            </div> 
						</div>
						<div class="form-row" style="margin-bottom: 10px;">
						...
						<div class="form-row" style="margin-bottom: 10px;">
						    ...
						    <div id="productName_pop" class="helppop" style="display: block;" aria-hidden="false">
                                 <div id="namehelp" class="helpctr" style="float: left; margin-left: 5px; width: 110px;font-size:12px;"><p>Please Enter Valid Product Brand And Model</p></div>
                            </div> 
						</div>
						<div class="form-row" style="margin-bottom: 10px;">
							...
							<div class="input-field">
								<input class="mandatory" name="batchNumber" id="productBatchNumberEdit" value="<%=vbProduct.getBatchNumber()%>">
							</div>
							<span id="batchNumberValidEdit" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
							 <div id="batchNumber_popEdit" class="helppop" style="display: block;" aria-hidden="false">
						...
						<div class="form-row" style="margin-bottom: 10px;">
							...
							<div class="input-field">
								<input class="mandatory costPerQtyEdit" name="costPerQuantity" id="costPerQuantity" value="<%=StringUtil.currencyFormat(vbProduct.getCostPerQuantity())%>">
							</div>
							<span id="productCostIsValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
			            ...
			            <input name="id" value="<%=vbProduct.getId()%>" type="hidden" id="productId">
				</div> 
			</div>
