...
<div id="employee-add-form-container" title="Create Employee">
	...
	<div class="ui-content form-panel full-content">
		...
		<form name="form1" id="employee-form" style="height: 335px;">
			<div class="add-student-tabs">
				...
				<div class="step-no-select">
					...
					<div class="tabs-title"><%=Msg.get(MsgEnum.EMPLOYEE_ADDITIONAL_INFO_LABEL)%>
					</div>
				</div>
				<div class="step-no-select">
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="form-row" style="margin-bottom: 30px;">
					...
					<div class="input-field" id="uName" style="width: 197px;">
						<input style="width: 65px; text-align: right; float:left;" class="read-only" id="orgPrefix" name="orgPrefix"
							readonly="readonly"> <input style="width: 115px;"
							class="mandatory constrained" name="username"
							id="username"
					...
					<!-- <div id="user_pop" class="helppop" style="display: block;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px;">
							<p>Username Already Exists</p>
				...
				<div class="form-row"
					...
					<div class="input-field" id="pName">
						<input class="mandatory" name="password" id="password"
							type="password">
					</div>
					<span id="pValid"
				...
				<div class="fieldset" style="height: 120px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory " name="firstName" id="firstName">
						</div>
					...
					<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.EMPLOYEE_MIDDLE_NAME_LABEL)%>
						</div>
						<div class="input-field">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="lastName" id="lastName">
						</div>
					...
					<div class="form-row" id='salesExecutive_granted_days'>
						...
						<span id="txnViewDayLengthValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						...
						<span id="txnViewDayMaxMinDaysValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
				...
				<div class="fieldset" style="height: 140px;">
					...
					<div class="fieldset-row" style="margin-top: 20px;">
						<div class="form-row">
							...
							<div class="input-field">
								<select name="employeeType" id="employeeType" class="mandatory constrained"
									constraints='{"fieldLabel":"Employee Type","mustSelect":"true"}'>
						...
						<div class="form-row">
							...
							<div class="input-field" style="width: 43px; ">
								<input id="male" type="radio" name="gender" class="gender "
									checked="checked" value="M" style="width: 20px;border: 0 !important;" /><span
									class="male"><%=Msg.get(MsgEnum.EMPLOYEE_GENDER_MALE_LABLE)%></span>
							</div>
							<div class="input-field" style="width: 43px;">
								<input id="female" type="radio" name="gender" class="gender "
									value="F" style="width: 20px;border: 0 !important;" /><span class="female"><%=Msg.get(MsgEnum.EMPLOYEE_GENDER_FEMALE_LABLE)%></span>
							</div>
						</div>
					</div>
		...
		<form id="employee-detail-form" style="height: 335px; display: none;">
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				...
				<div class="separator" style="height: 150px; margin-left: 100px;"></div>
				<div class="fieldset" style="height: 150px;">
					<div class="form-row">
		...
		<form id="employee-address-form" name="form2" style="height: 335px; display: none;">
			<div class="add-student-tabs">
				<div class="step-no-select">
					<div class="tabs-title"><%=Msg.get(MsgEnum.EMPLOYEE_BASIC_INFO_LABEL)%>
					</div>
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 150px;">
					...
					<%-- <div class="form-row">
										<div class="label"><%=Msg.get(MsgEnum.CUSTOMER_REGION) %></div>
										<div class="input-field"><input class="mandatory constrained"  name="region" id="region" constraints='{"fieldLabel":"region","charsOnly":"true"}' ></div>
									</div> --%>
				</div>
				<div class="separator" style="height: 150px; margin-left: 100px;"></div>
				<div class="fieldset" style="height: 150px;">
					...
					<div class="form-row">
						<div class="input-field">
							<input name="action" value="save-address" type="hidden"
								id="employeeAction">
						</div>
					</div>
				</div>
		...
		<div id="page-buttons" class="page-buttons"
			style="margin-left: 240px; margin-top: 75px;" align="center">
...
<script type="text/javascript">
	...
	//EmployeeHandler.initCheckUsername();
	EmployeeHandler.initCheckUsername();
	...
	EmployeeHandler.getOrganizationPrefeix();
