  ...
  <div id="employee-add-form-container" title="Create employee">
	...
	<div class="ui-content form-panel full-content">
		...
		if(importsession.getAttribute("failureMsg") != null){
			...
			<div style="height:300px;color:#3FA8FB; margin:25px; overflow-y:scroll; border:1px solid #f6f6f6;font:bold 18px arial;text-align: center;word-wrap: break-word;">&nbsp;<% out.println(importsession.getAttribute("failureMsg")); %></div>
			<%
		}
