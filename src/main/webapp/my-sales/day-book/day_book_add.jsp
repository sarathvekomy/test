			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 100px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory read-only" name="salesExecutive"
								id="salesExecutive" value=<%=user.getName()%>
								readonly="readonly">
						</div>
					</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="allotStockOpeningBalance"
								id="allotStockOpeningBalance" class="read-only"
								readonly="readonly">
						</div>
					</div>
					<div class="separator" style="height: 10px;"></div>
					<div class="form-row">
						<div class="input-field" style="width: 35px !important;">
							<input name="isReturn" id="isReturn" type="checkbox"
								style="width: 28px !important; border: 0 !important;">
						</div>
						<div class="label"
							style="float: left; margin-left: -5px; margin-top: 4px;"><%=Msg.get(MsgEnum.DAY_BOOK_IS_RETURN)%>
						</div>
					</div>
				</div>
						...
						<div class="form-row" id="presentDate">
							...
							<div class="input-field">
								<input name="currentDate" id="currentDate"
									value="<%=DateUtils.format(new Date())%>" class="read-only"
									readonly="readonly">
							</div>
						</div>
						<div class="separator" style="height: 10px;"></div>
				...
				<div class="form-row">
					...
					<textarea style="float: left; margin-left: 60px;" name="dayBookRemarks"
						id="remarks" cols="70" rows="3"></textarea>
				</div>
			</div>
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 100px;">
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 120px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory read-only" name="vehicleNo"
								id="vehicleNo" readonly="readonly"> <span
								id="vehicleNOValid"
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input name="driverName" id="driverName"
								class="mandatory read-only" readonly="readonly">
						</div>
				...
				<div id="dynamic-display">
					<div class="fieldset" style="height: 120px;">
						<div class="form-row">
							...
							<div class="input-field">
								<input name="startingReading" id="startReading"
									readonly="readonly" class="mandatory read-only">
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="input-field">
								...
								<div id="readingLen_pop" class="helppop"
									style="display: block; float: left; margin-left: 130px;"
									aria-hidden="false">
									<div id="namehelp" class="helpctr"
										style="float: left; margin-left: 10px;">
					...
					<div class="form-row" style="width: 279px" !important>
						...
						id="remarks" cols="70" rows="4"></textarea>
						</div>
					</div>
					<div class="fieldset-row" style="margin-top: 10px;">
						<div class="fieldset" style="height: 100px;">
		...
		<form name="day-book-allowances-form" id="day-book-allowances-form"
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 200px;">
					<div class="form-row">
						<a id="executiveAllowancesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_EXECUTIVE_ALLOWANCES)%>
							</div></a>
						<div class="input-field">
							<input name="executiveAllowances" id="executiveAllowances"
								class="allowances read-only" readonly="readonly">
						</div>
						<span id="executiveallValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="executiveall_pop" class="helppop"
					...
					<div class="separator" style="height: 10px;"></div>
					<div class="form-row">
						<a id="driverAllowancesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_DRIVER_ALLOWANCES)%></div></a>
						<div class="input-field">
					...
					<div class="form-row">
						<a id="vehicleFuelExpensesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_VEHICLE_FUEL_EXPENSES)%></div></a>
						<div class="input-field">
					...
					<div class="form-row">
						<a id="municipalCityCouncilLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_MUNICIPAL_CITY_COUNCIL)%></div></a>
						<div class="input-field">
				...
				<div class="fieldset" style="height: 200px;">
					<div class="form-row">
						<a id="vehicleMaintenanceExpensesLink" href="#"><div
								class="label"><%=Msg.get(MsgEnum.DAY_BOOK_VEHICLE_MAINTENANCE_EXPENSES)%></div></a>
						<div class="input-field">
							</a><input name="vehicleMaintenanceExpenses"
					...
					<div class="separator" style="height: 10px;"></div>
					<div class="form-row">
						<a id="offloadingChargesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_OFFLOADING_CHARGES)%></div></a>
						<div class="input-field">
							<input name="offloadingLoadingCharges"
								id="offloadingLoadingCharges" class="allowances read-only"
								readonly="readonly">
						</div>
					</div>
					<div class="separator" style="height: 10px;"></div>
					<div class="form-row">
						<a id="miscellaneousExpensesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_MISCELLANEOUS_EXPENSES)%></div></a>
						<div class="input-field">
					...
					<div class="separator" style="height: 10px;"></div>
					<div class="form-row">
						<a id="dealerPartyExpensesLink" href="#"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_DEALER_PARTY_EXPENCES)%></div></a>
						<div class="input-field">
					...
					<div class="form-row" style="margin-top: 10px;">
						...
						<div class="input-field">
							<input name="totalAllowances" id="totalAllowances"
								class="mandatory totalAllowances read-only" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="form-row">
					<div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_REMARKS)%></div>
					<textarea style="float: left; margin-left: 60px;" name="allowancesRemarks"
						id="remarks" cols="70" rows="3"></textarea>
				</div>
			</div>
			<div class="fieldset-row" style="margin-top: 10px;">
		...
		<form name="day-book-amount-form" id="day-book-amount-form"
			...
			<div class="fieldset-row" style="margin-top: 10px;">
				...
				<div class="fieldset" style="height: 110px;">
					<div class="form-row">
						<a href="#" id="amountToBankLink"><div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_AMOUNT_TO_BANK)%></div></a>
						<div class="input-field">
							<input name="amountToBank" id="amountToBank" class="read-only"
								readonly="readonly">
						</div>
						<span id="amountTobankValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="amountTobank_pop" class="helppop"
							style="display: block; margin-top: -5px;" aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
					...
					<div class="form-row">
						...
						<span id="amountToFactoryValid"
							style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="amountToFactory_pop" class="helppop"
							style="display: block; margin-top: -5px;" aria-hidden="false">
							<div id="namehelp" class="helpctr"
								style="float: left; margin-left: 3px; margin-top: 2px;">
				...
				<div class="form-row">
					<div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_REMARKS)%></div>
					<textarea style="float: left; margin-left: 60px;" name="amountsRemarks"
						id="remarks" cols="70" rows="3"></textarea>
				</div>
			</div>
			<div class="fieldset-row" style="margin-top: 10px;">
			...
			<div class="fieldset-row" style="margin-top: 20px;">
				<div class="fieldset" style="height: 200px; width: 699px;">
					...
					<div id="search-results-list" class="green-results-list"
						style="height: 150px; width: 830px; overflow-x: hidden;"></div>
				</div>
				<div class="separator" style="height: 10px;"></div>
				<div class="form-row">
					<div class="label"><%=Msg.get(MsgEnum.DAY_BOOK_REMARKS)%></div>
					<textarea style="float: left; margin-left: 60px;" name="productsRemarks"
						id="productsRemarks" cols="72" rows="3"></textarea>
				</div>
			</div>
			<div class="fieldset" style="height: 100px;">
					<div class="form-row">
...
<div id="driver-allowances-view-dialog" style="display: none;"
	title="Driver Allowances Details">
