...
String currency=user.getOrganization().getCurrencyFormat();
	...
	/* if(vbJournal != null){
		vbEmployee=journalDao.getSalesExecutiveFullName(vbJournal.getCreatedBy(),user.getOrganization());
	} */
		}
	} catch (Exception exx) {
		exx.printStackTrace();
...
<div class="outline" style="margin-left: 10px;">
	...
	<div class="first-row" style="width:960px;">
		...
		<div class="left-align">
			...
			<div class="number" style="margin-left: 140px;">
				<div class="input-field-preview" style="width: 620px;">
							<span class="property-value"><%=str%><%=StringUtil.format(vbJournal.getDescription())%></span>
						</div>
			</div>
		</div>
	</div>
