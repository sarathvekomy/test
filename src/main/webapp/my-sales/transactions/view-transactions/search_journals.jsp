			...
			<div class="fieldset-row" style="height: 60px; margin-top: 10px;">
				<div class="fieldset" style="height: 40px;">
					<div class="form-row">
						...
						<div class="input-field">
								...
								<option title="select" value="" selected="selected"></option>
								</select>
						</div>
					</div>
					<div class="form-row">
				...
				<div class="fieldset" style="height: 40px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="datepicker" name="createdOn" id="createdOn" readonly="readonly">
						</div>
					</div>
				</div>
...
<div id="previous-journals-view-dialog-1" style="display: none" title="Journal">
	<div id="previous-journals-view-container-1" style="width: 200px; height: 200px"></div>
</div>
<div id="previous-journals-view-dialog-2" style="display: none" title="Journal">
	<div id="previous-journals-view-container-2" style="width: 200px; height: 200px"></div>
</div>
<div id="previous-journals-view-dialog-3" style="display: none" title="Journal">
	<div id="previous-journals-view-container-3" style="width: 200px; height: 200px"></div>
</div>
<div id="previous-journals-view-dialog-4" style="display: none" title="Journal">
	<div id="previous-journals-view-container-4" style="width: 200px; height: 200px"></div>
</div>
<div id="previous-journals-view-dialog-5" style="display: none" title="Journal">
	<div id="previous-journals-view-container-5" style="width: 200px; height: 200px"></div>
</div>
