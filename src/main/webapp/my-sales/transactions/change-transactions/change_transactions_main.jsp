...
<script type="text/javascript" src="js/my-sales/transacations/change-transactions.js"></script>
<script type="text/javascript" src="js/my-sales/transacations/validate-change-transactions.js"></script>
