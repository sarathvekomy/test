			...
			count++;%>
			 ...
			 <% if(alternateProduct){
					%><tr class="row" id="row-<%=count%>" style="background:#eaeaea;width:821px;"><%}
 					...
 					<td><%=count%></td>
 	    		    <td style="word-wrap:break-word;" id="productName"><%=StringUtil.format(product.getProduct())%></td>
 	    		    <td style="word-wrap:break-word;" id="batchNumber"><%=StringUtil.format(product.getBatchNumber())%></td>
 	    		     <td align="right" id="damaged"><%=StringUtil.quantityFormat(product.getDamaged())%></td>
 	    		      <td align="right" id="resalable"><%=StringUtil.quantityFormat(product.getResalable())%></td>
 	    		      <td align="right" id="totalQuantity"><%=StringUtil.quantityFormat(product.getTotalQty())%></td>
 	    		      <td align="right" id="productCost"><%=StringUtil.format(product.getProductCost())%></td>
 	    		      <td align="right"><input type="text" id="damagedCost" style="text-align:right !important;"></td>
 	    		      <td align="right"><input type="text" id="resalableCost" style="text-align:right !important;"></td>
