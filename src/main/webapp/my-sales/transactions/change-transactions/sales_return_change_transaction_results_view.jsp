...
<div class="first-row">
		<div class="left-align">
			...
			<a id="change-request-salesreturn-Invoice-number" href="#" class="<%=invoiceNumber%>" align="<%=salesReturnId%>" style="color:#000; font-weight:bold; outline:none;text-decoration:none !important;">
