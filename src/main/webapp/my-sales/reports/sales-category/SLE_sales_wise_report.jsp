...
%>
<div id="reports-add-form-container" title="SLE Sales Wise Report" style="overflow: auto; width:100%; float:left;height:468px !important;background:#fff;">
	<div class="ui-content form-panel full-content">
		<form id="sle-sales-wise-report-form" style="height: 150px;">
				...
				<div class="fieldset" style="height: 60px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input name="salesExecutive" id="salesExecutive">
						</div>
		...
		<div id="page-buttons" class="page-buttons"
			...
			<div id="sle-sales-action-show" class="ui-btn btn-show">Show</div>
			<div id="sle-sales-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="sle-sales-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="sle-sales-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="sle-sales-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
		<div id="report-show-dialog" style="display: none; overflow-y: hidden;overflow-x: scroll"
			title="Sales Executive Sales Wise Report">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.helppop').hide();
		SalesExecutiveSalesWiseReportHandler.load();
		SalesExecutiveSalesWiseReportHandler.registorReportShowEvents();
