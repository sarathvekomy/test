...
%>
<div id="reports-add-form-container" title="Customer Product Sales Report" style="overflow: auto; width:100%; float:left;height:468px !important;background:#fff;">
	<div class="ui-content form-panel full-content">
		<form id="customer-product-sales-report-form" style="height: 150px;">
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 60px;">
					...
					<div class="input-field">
						<input  name="businessName"
							id="businessName" class="mandatory"
				...
				<div id="business-name-suggestions" style="z-index: 10;position: absolute;"
		...
		<div id="page-buttons" class="page-buttons"
		    ...
		    <div id="customer-product-sales-action-show" class="ui-btn btn-show">Show</div>
			<div id="customer-product-sales-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="customer-product-sales-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="customer-product-sales-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="customer-product-sales-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
		<div id="report-show-dialog" style="display: none; overflow-y: hidden;overflow-x: scroll;"
			title="Customer Product Sales Wise Report">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.helppop').hide();
		CustomerProductSalesReportHandler.load();
		CustomerProductSalesReportHandler.registorReportShowEvents();
