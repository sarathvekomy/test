...
%>
<div id="reports-add-form-container" title="Customer Wise Report"
	...
	<div class="ui-content form-panel full-content">
		<form id="customer-wise-report-form" style="height: 150px">
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="fieldset" style="height: 60px;">
					<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.DELIVERY_NOTE_BUSINESS_NAME_LABEL)%>
						</div>
					...
					<div class="form-row">
						...
						<div class="input-field">
							<select name="reportType" id="reportType">
								...
								<%
									for (String reportType : DropDownUtil.getDropDown(
											DropDownUtil.REPORT_TYPE).keySet()) {
								%>
								<option value="<%=reportType%>"><%=DropDownUtil.getDropDown(DropDownUtil.REPORT_TYPE,
						reportType)%></option>
								<%
									}
								%>
