...
%>
<div id="reports-add-form-container" title="Product Report Wise" style="overflow: hidden;width:100%; float:left;height:468px !important;background:#fff;">
	<div class="ui-content form-panel full-content">
		...
		<div id="page-buttons" class="page-buttons"
			...
			<div id="product-report-action-show" class="ui-btn btn-show">Show</div>
			<div id="product-report-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="product-report-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="product-report-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="product-report-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.helppop').hide();
		ProductReportWiseReportHandler.load();
		ProductReportWiseReportHandler.registorReportShowEvents();
