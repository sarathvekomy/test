...
<div id="reports-add-form-container" title="Product Wise Report" style="overflow: auto;width:100%; float:left;height:468px !important;background:#fff;">
	...
	<div class="ui-content form-panel full-content">
		...
		<div id="page-buttons" class="page-buttons"
			...
			<div id="product-action-show" class="ui-btn btn-show">Show</div>
			<div id="product-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="product-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="product-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="product-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
