...
%>
<div id="reports-add-form-container" title="Product Report SLE" style="overflow: auto;width:100%; float:left;height:468px !important;background:#fff;">
	<div class="ui-content form-panel full-content">
		<form id="product-report-sle-report-form" style="height: 150px;">
		...
		<div id="page-buttons" class="page-buttons"
			...
			<div id="product-report-sle-action-show" class="ui-btn btn-show">Show</div>
			<div id="product-report-sle-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="product-report-sle-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="product-report-sle-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="product-report-sle-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
		<div id="report-show-dialog" style="display: none; overflow-y: hidden;overflow-x: scroll;"
			title="Sales Executive Product Wise Report">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.helppop').hide();
		ProductReportSLEWiseReportHandler.load();
		ProductReportSLEWiseReportHandler.registorReportShowEvents();
