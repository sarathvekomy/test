...
%>
<div id="reports-add-form-container" title="Product Wise Report" style="overflow: auto;width:100%; float:left;height:468px !important;background:#fff;">
	<div class="ui-content form-panel full-content">
		<form id="factory-product-wise-report-form" style="height: 150px;">
		...
		<div id="page-buttons" class="page-buttons"
			...
			<div id="factory-product-action-show" class="ui-btn btn-show">Show</div>
			<div id="factory-product-action-pdf" class="ui-btn btn-print">Download PDF</div>
			<div id="factory-product-action-xls" class="ui-btn btn-print">Download CSV</div>
			<div id="factory-product-action-clear" class="ui-btn btn-clear">Clear</div>
			<div id="factory-product-action-cancel" class="ui-btn btn-cancel">Cancel</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.helppop').hide();
		FactoryProductWiseReportHandler.load();
		FactoryProductWiseReportHandler.registorReportShowEvents();
