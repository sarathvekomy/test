...
<div id="product-add-form-container" title="View Product">
	...
	<div class="main-table"
		...
		<div class="display-boxes-product-view-colored">
			...
			<div class="display-boxes-product-view-colored">
				<div>
					<span class="span-label" style="text-align:left !important;">Cost per Quantity (<%=currencyFormat%>)</span>
				</div>
			</div>
			<div class="display-boxes-product-view">
				<div>
			...
			<div class="display-boxes-product-view" style="height:auto !important; min-height:20px;word-wrap:break-word;">
				<div>
