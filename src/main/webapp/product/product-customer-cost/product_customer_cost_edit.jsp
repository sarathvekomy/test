...
<div id="product-customer-cost-form-container" title="Product Customer Cost">
	...
	<div class="ui-content form-panel full-content">
		<form id="product-customer-cost-add-form" style="height: 280px;">
			 <div class="fieldset-row" style="margin-top: 0px;">
			   <div class="fieldset" style="height: 120px;">
		        ...
		        <div class="form-row"> 
			    <div id="search-results-list" class="green-results-list" style="height: 320px; width: 697px; overflow-x: hidden; overflow-y: scroll;">
		   ...
		   if(productList.get(i).getProductName().length() > 80 || productList.get(i).getBatchNumber().length() > 80){
				 %>
				 <div class="report-body" id="product-customer-cost" style="height: 170px; overflow: hidden;">
				    <div id="productNumber">
				                <div class="report-body-column2 centered sameheightcolumns" id="productId " style="width: 80px;height: 170px;"><%=productList.get(i).getId()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="productName" style="height: 170px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getProductName() %></div>
								<div class="report-body-column2 centered sameheightcolumns" id="batchNumber" style="height: 170px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getBatchNumber()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="costPerQuantity" style="height: 170px; width: 130px; word-wrap: break-word; text-align: right;"><%=productList.get(i).getCostPerQuantity()%></div>
								<div class="report-body-column2 centered sameheightcolumns" style="height: 170px; width: 130px;"> 
					            <div class="input-field">
					            <input  class="mandatory"  name="customerCost" id="customerCost" value="<%=productList.get(i).getCost()%>" style="height: 16px; width: 100px;  border:1px solid #049fff; text-align: right;">
	          ...
	          <%}else if(productList.get(i).getProductName().length() > 50 || productList.get(i).getBatchNumber().length() > 50){
	           %>
				 <div class="report-body" id="product-customer-cost" style="height: 120px; overflow: hidden;">
				    <div id="productNumber">
				                <div class="report-body-column2 centered sameheightcolumns" id="productId " style="width: 80px;height: 120px;"><%=productList.get(i).getId()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="productName" style="height: 120px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getProductName() %></div>
								<div class="report-body-column2 centered sameheightcolumns" id="batchNumber" style="height: 120px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getBatchNumber()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="costPerQuantity" style="height: 120px; width: 130px; word-wrap: break-word;text-align: right;"><%=productList.get(i).getCostPerQuantity()%></div>
								<div class="report-body-column2 centered sameheightcolumns" style="height: 120px; width: 130px;"> 
					            <div class="input-field">
					            <input  class="mandatory"  name="customerCost" id="customerCost" value="<%=productList.get(i).getCost()%>" style="height: 16px; width: 100px;  border:1px solid #049fff; text-align: right;">
					            <span id="customerCost-"<%=count++%> style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					            </div>
	           ...
	           %>
				 <div class="report-body" id="product-customer-cost" style="height: 70px; overflow: hidden;">
				    <div id="productNumber">
				                <div class="report-body-column2 centered sameheightcolumns" id="productId " style="width: 80px;height: 70px;"><%=productList.get(i).getId()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="productName" style="height: 70px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getProductName() %></div>
								<div class="report-body-column2 centered sameheightcolumns" id="batchNumber" style="height: 70px; width: 130px; word-wrap: break-word;"><%=productList.get(i).getBatchNumber()%></div>
								<div class="report-body-column2 centered sameheightcolumns" id="costPerQuantity" style="height: 70px; width: 130px; word-wrap: break-word;text-align: right;"><%=productList.get(i).getCostPerQuantity()%></div>
								<div class="report-body-column2 centered sameheightcolumns" style="height: 70px; width: 130px;"> 
					            <div class="input-field">
					            <input  class="mandatory"  name="customerCost" id="customerCost" value="<%=productList.get(i).getCost()%>" style="height: 16px; width: 100px;  border:1px solid #049fff; text-align: right;">
					            <span id="customerCost-"<%=count++%> style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					            </div>
	             ...
	             <div class="report-body-column2 centered" id="productId " style="width: 80px;height: 20px;"><%=productList.get(i).getId()%></div>
					...
					<div class="report-body-column2 centered" id="costPerQuantity" style="height: 20px; width: 130px;text-align: right;"><%=productList.get(i).getCostPerQuantity()%></div>
		...
		<div id="page-buttons" class="page-buttons"
			style="margin-left: 200px; margin-top: 110px;">
			<div id="button-prev" class="ui-btn btn-prev" style="display: none">Prev</div>
			<div id="button-next" class="ui-btn btn-next" style="display: none">Next</div>
			<div id="button-update-product-customer-cost" class="ui-btn btn-update">Update</div>
			<div id="action-edit-clear" class="ui-btn btn-clear">Clear</div>
			<div id="action-cancel-product-customer-cost" class="ui-btn btn-cancel">Cancel</div>
		</div>
	</div>
</div>
<script type="text/javascript">
