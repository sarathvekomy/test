...
ProductCustomerCostOtherUserHandler.initProductCustomerCostSearchResultOnLoad();
ProductCustomerCostOtherUserHandler.initSearchProduct(<%=user.getRoles().contains("ROLE_MANAGEMENT")%>); 
</script>
