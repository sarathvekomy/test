...
<div class="table-field" style="height: 150px;">
	<div class="main-table">
		<div class="inner-table">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"
						Style="padding-left: 2px; word-wrap: break-word;" id="mail"></span>
				</div>
			</div>
			<div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes-colored">
				<div>
					<span class="span-label" style="height: 40px;">Alternate
						Mobile No</span>
				</div>
			</div>
			<div class="display-boxes">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"
						Style="padding-left: 2px; word-wrap: break-word" id="address1"></span>
				</div>
			</div>
			<div class="display-boxes-colored">
				<div>
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"
						Style="padding-left: 2px; word-wrap: break-word" id="address2"></span>
				</div>
			</div>
		</div>
	</div>
	<div class="main-table">
		<div class="inner-table">
			...
			<div class="display-boxes">
				<div>
					<span class="property-value"
						Style="padding-left: 2px; word-wrap: break-word" id="state"></span>
				</div>
			</div>
			<div class="display-boxes-colored">
				<div>
...
<div class="table-field" style="margin-top: 15px;">
	<div class="main-table">
		<div class="inner-table">
			<div class="display-boxes-colored">
				<div>
					<span class="span-label">Credit Limit (<%=currency%>)
					</span>
				</div>
			</div>
