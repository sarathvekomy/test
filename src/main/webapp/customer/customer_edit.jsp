...
<div class="ui-content form-panel full-content">
	<form id="customer-form" style="height: 335px;">
		...
		<div class="fieldset-row" style="margin-top: 10px;">
			<div class="fieldset-row" style="margin-top: 10px;">
				<div class="form-row" style="margin-bottom: 30px;">
					...
					<div class="input-field" id="bName">
						<input class="mandatory constrained" name="businessName"id="businessName"constraints='{"fieldLabel":"businessName","charsOnly":"true"}'/>
					</div>
					<span id="bValid" style="margin-left: -10px;"></span>
					<span id="businessNameValid"style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
					<div id="businessName_pop" class="helppop" style="display: block;"aria-hidden="false">
				...
				<div class="fieldset" style="height:40px;">
					...
					<div class="form-row">
						...
						<div class="input-field" style="width: 43px;">
							<input id="male" type="radio" name="gender" class="gender "value="M" style="width: 20px;" />
							<span class="male"><%=Msg.get(MsgEnum.CUSTOMER_GENDER_MALE_LABLE)%></span>
						</div>
						<div class="input-field" style="width: 43px;">
							<input id="female" type="radio" name="gender" class="gender "value="F" style="width: 20px;" /><span class="female"><%=Msg.get(MsgEnum.CUSTOMER_GENDER_FEMALE_LABLE)%></span>
						</div>
					</div>
				</div> 
				</div>
			...
			<div class="fieldset-row" style="margin-top:20px;">
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory constrained"constraints='{"fieldLabel":"mobile","numbersOnly":"true"}'name="mobile" id="mobile">
							 <span id="mobileValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
							<div id="mobile_pop" class="helppop" style="display: block;float:left;margin-left:140px;margin-top:-25px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:2px;">
							<p><%=Msg.get(MsgEnum.VALIDATE_MOBILE) %> </p>
						</div>
					</div>
					<div id="mobilelen_pop" class="helppop" style="display: block;float:left;margin-left:140px;margin-top:-25px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:2px;">
			...
			<div class="fieldset" style="height:60px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input  name="email" id="Email"constraints='{"fieldLabel":"Email Id","email":"true"}'>
						 <span id="emailValid" style="float: left; position: absolute; margin-left: 145px; margin-top: -25px"></span>
					<div id="email_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"aria-hidden="false">
						<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;margin-top:2px;"">
							<p><%=Msg.get(MsgEnum.VALIDATE_EMAIL) %></p>
						</div>
					</div>
					<div id="emaillen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:2px;"">
			...
			<div class="fieldset" style="height: 20px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input
							constraints='{"fieldLabel":"creditLimit","numbersOnly":"true"}'name="creditLimit" id="creditLimit">
							 <span id="creditLimitValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
							<div id="creditlimit_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:2px;">
							<p><%=Msg.get(MsgEnum.VALIDATE_CREDIT_LIMIT) %></p>
						</div> 
					</div>
					<div id="creditlimitlen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:2px;">
			...
			<div class="fieldset" style="height: 20px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input 	constraints='{"fieldLabel":"creditOverDueDays","numbersOnly":"true"}'name="creditOverdueDays" id="creditOverdueDays">
						 <span id="overduesValid" style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
							<div id="overdues_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:-5px;">
							<p><%=Msg.get(MsgEnum.VALIDATE_CREDIT_OVER_DUE_DAYS) %></p>
						</div>
					</div>
					<div id="overdueslen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"aria-hidden="false">
						<div id="namehelp" class="helpctr"style="float: left; margin-left: 3px;margin-top:-5px;">
	...
	<form id="customers-detail-form" style="height:335px; display: none;">
		<div class="add-student-tabs">
			<div class="step-no-select">
		...
		<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input name="directLine" id="directLine"constraints='{"fieldLabel":"creditOverDueDays","numbersOnly":"true"}'>
						<span id="directLineValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
			...
			<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						...
						<span id="altmobileValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
			...
			<div class="fieldset" style="height: 10px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input name="addressLine1" id="addressLine1" maxlength="45">
							 <span id="addressLine1Valid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
            ...
            <div id="addressLine1len_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
				...
				<div class="form-row">
					...
					<span id="address2Valid"style="float: left; position: absolute; margin-left: 5px; margin-top: -2px"></span>
							<div id="addressLine2_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:280px;" aria-hidden="false">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input class="mandatory constrained" name="locality" id="locality"constraints='{"fieldLabel":"locality","charsOnly":"true"}'>
						<span id="localityValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="landmark" id="landmark">
						 <span id="landmarkValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
		...
		<div class="separator" style="height: 80px;"></div>
			<div class="fieldset" style="height: 60px;">
				<div class="form-row">
					...
					<div class="input-field">
						<input class="mandatory constrained" name="region" id="region"constraints='{"fieldLabel":"region","charsOnly":"true"}'>
						<span id="regionValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input  name="state" id="state"constraints='{"fieldLabel":"state","charsOnly":"true"}'>
						<span id="stateValid"
            ...
            <div id="statelen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;"  aria-hidden="false">
				...
				<div class="form-row">
					...
					<div class="input-field">
						<input name="city" id="city"constraints='{"fieldLabel":"city","charsOnly":"true"}'>
						 <span id="cityValid" style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
							<div id="city_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
                <div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;margin-top:2px;">
                <p><%=Msg.get(MsgEnum.VALIDATE_CITY) %></p>
                </div>
            </div>
            <div id="citylen_pop" class="helppop" style="display: block;margin-top:-25px;float:left;margin-left:140px;" aria-hidden="false">
				...
				<div class="form-row">
					...
					<div class="input-field">
						...
						<span id="zipcodeValid"style="float: left; position: absolute; margin-left: 145px; margin-top: -20px"></span>
...
<script type="text/javascript">
	...
	CustomerHandler.initCheckEditBusinessName();
