...
%>
				<div id="customer-search-form-container" class="ui-container" title="Search Customer">
					...
					<div class="ui-content form-panel form-panel-border">												
						...
						<div id="search-buttons" class="search-buttons">
							<div id="action-search-customer" class="ui-btn btn-search">Search</div>
				...
				<div id="customer-documents-dialog" style="display: none;" title="Customer View Documents">
					<div id="customer-documents-container"></div>
				</div>
				<div id="customer-enable-disable-view-dialog" style="display: none;" title="Customer Enable Disable">
					<div id="customer-enable-disable-view-container"></div>
				</div>
