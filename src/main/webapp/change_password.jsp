...
<body onload='document.f.j_username.focus();'>
    ...
    <span style="color:#fff; margin-left:465px;">Login Success,As this your first time login please change your password</span>
    <%
	...
	loginDao.isFirstTimeLogin(user.getName(), user.getOrganization());
	...
	loginDao.comparePasswords(user.getName(),request.getParameter("oldPassword"), user.getOrganization());
	...
	if(request.getParameter("oldPassword")!=null && password!=null){
		...
		}else if(!loginDao.comparePasswords(user.getName(),request.getParameter("oldPassword"), user.getOrganization())){
			failure="Old password incorrect";	
			password=null;
		}
	}
	if(password!=null){
		loginDao.changePassword(password, user.getName(), user.getOrganization());
