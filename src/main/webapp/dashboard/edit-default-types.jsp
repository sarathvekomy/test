...
<%
	...
	try {
		...
		SyStemDefaultsDao syStemDefaultsDao = (SyStemDefaultsDao) hibernateContext.getBean("systemDefaultsDao");
		if (syStemDefaultsDao != null) {
			if (type.equals("EmployeeType")) {
				vbRole = (VbRole) syStemDefaultsDao.getEmployeetypeById(id);
			} else if (type.equals("Address Type")) {
				vbAddressTypes = (VbAddressTypes) syStemDefaultsDao.getAddTypeById(id);
			} else if (type.equals("Payment Type")) {
				vbPaymentTypes = (VbPaymentTypes) syStemDefaultsDao.getPayTypeById(id);
