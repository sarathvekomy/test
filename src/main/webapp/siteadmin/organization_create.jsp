...
<div id="organization-create-form-container">
	...
	<form id="organization-form"style="height: 335px;">
		<div class="add-student-tabs">
			...
			<div class="fieldset-row" style="height: 320px; margin-top:-5px;">
				...
				<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="input-field">
							<input class="mandatory" name="mainBranchName" id="mainBranchName" disabled="disabled" readonly="readonly">
						</div>
				...
				<div class="form-row">
					...
					<div class="fieldset" style="height: 20px; margin-top:-15px;">
					<div class="form-row">
					...
					<div class="fieldset" style="height: 20px;margin-top:-15px;">
					<div class="form-row">
						<div class="label"><%=Msg.get(MsgEnum.ORGANIZATION_USERNAME_PREFIX_LABEL) %> </div>
						<div class="input-field">
							<input class="mandatory" name="usernamePrefix" id="usernamePrefix">
						</div>
						<span id="prefixValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
						<div id="prefix_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p>User Name Prefix can contain letters, numbers, periods (.) and at the rate (@) and spaces.</p>
							</div>
						</div>
						<div id="prefixValid_pop" class="helppop" style="display: block;" aria-hidden="false">
							<div id="namehelp" class="helpctr" style="float: left; margin-left: 3px;">
								<p> This User Name Prefix Already Exists.</p>
							</div>
						</div>
					</div>
					<div class="form-row">
					...
					<div class="fieldset" style="height: 30px;margin-top:-15px;">
					<div class="form-row">
					...
					<div class="form-row">
						<div class="label" style="margin-left: 10px;"><%=Msg.get(MsgEnum.ORGANIZATION_DESCRIPTION_LABEL) %></div>
						<div class="input-field">
							<textarea name="description" id="description" rows="3" cols="76" style="margin-left: -2px;"></textarea>
						</div>
					...
					<input name="action" value="save-organization" type="hidden" id="organizationAction">
				</div>
				</form>
				<form id="organization-superuser-form" style="display: none;height:335px;">
				<div class="add-student-tabs">
				<div class="step-no-select">
				...
				<div class="fieldset-row" style="height: 70px; margin-top:5px;">
				<div class="fieldset" style="height: 20px;">
					<div class="form-row">
					<div class="label" style="width:73px; !important;"><%=Msg.get(MsgEnum.EMPLOYEE_USERNAME)%>
					</div>
					<div class="input-field" id="uName" style="width: 197px;">
						<input style="width: 75px; text-align: right;" class="read-only" id="orgPrefix" name="orgPrefix"
							readonly="readonly"> <input style="width: 115px;"
							class="mandatory constrained" name="superUsername"
							id="username"
					...
					<div id="username_popDuplicate" class="helppop" style="display: block;"
						aria-hidden="false">
						<div id="namehelp" class="helpctr"
							style="float: left; margin-left: 3px;">
					...
					<div class="form-row">
						...
						<span id="fullNameValid" style="float: left; position: absolute; margin-left: 5px; margin-top: 5px"></span>
				...
				<div class="separator" style="height: 20px; margin-left: 100px;"></div>
					<div class="fieldset" style="height: 40px;">
						...
						<div class="input-field" id="pName">
							<input class="mandatory constrained" constraints='{"fieldLabel":"Password","choose":"true"}' name="password" id="password" type="password">
						</div>
		...
		<div id="page-buttons" class="page-buttons"	style="margin-left: 200px; margin-top: 70px;">
			...
			<button id="action-save" class="ui-btn btn-save" style="display: none;">Save</button>
...
<div id="organization-code-suggestions" style="display: none; position: absolute;" class="timetable-teacher-suggestions">
	<img id="exposeMask_loading_img" src="images/common/ajax-loader.gif" alt="loading.." style="z-index: 999; position: absolute; top: 43px; left: 390px;">
</div>
...
<script type="text/javascript">
	$(document).ready(function() {
      	...
      	OrganizationHandler.initCheckOrganizationCode();
		OrganizationHandler.initOrganizationName();
		UserHandler.initCheckPassword();
		//OrganizationHandler.checkUserPrefix();
		OrganizationHandler.initAdd();
		$('.helppop').hide();
		$(document).click(function(e) { $('.auto-suggestions').hide()});
	});
