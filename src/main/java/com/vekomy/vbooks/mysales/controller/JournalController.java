/**
 * com.vekomy.vbooks.mysales.controller.JournalController.java
 *
 ...
 * 
 */
public class JournalController extends JsonFormController {
	/**
	 * Logger variable holds _logger.
	 */
	private static final Logger _logger = LoggerFactory.getLogger(JournalController.class);
	...
	public ModelAndView onSubmit(HttpServletRequest request,
		...
		IResult result = getAction(request, "journalAction").process(command);
