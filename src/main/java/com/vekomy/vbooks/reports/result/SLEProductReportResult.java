/**
 * com.vekomy.vbooks.reports.result.SLEProductReportResult.java
 *
 ...
 *
 */
public class SLEProductReportResult implements Serializable{
	...
	/**
	 * Integer variable holds recievedQty
	 */
