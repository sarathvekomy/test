...
public class VbDayBookChangeRequestAmount implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = -1463568825724023943L;
	private Integer id;
	...
	public VbDayBookChangeRequestAmount(
			...
			String dealerPartyExpenses, String reasonDealerPartyExpenses,
			String municipalCityCouncil, String miscellaneousExpenses,
			String reasonMiscellaneousExpenses, String totalAllowances,
			String allowancesRemarks, String customerTotalPayable,
			String customerTotalReceived, String customerTotalCredit,
			String amountToBank, String amountsRemarks, String amountToFactory,
