...
public class VbSalesBookProducts implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = -476804771531211348L;
	private Integer id;
	private VbSalesBook vbSalesBook;
	private String productName;
	private String batchNumber;
	private Integer recentAllotment;
	...
	public VbSalesBookProducts(VbSalesBook vbSalesBook, String productName,
			String batchNumber, Integer recentAllotment, Integer qtyAllotted, Integer qtyOpeningBalance,
			Integer qtySold, Integer qtyToFactory, Integer qtyClosingBalance,
			String remarks) {
		this.vbSalesBook = vbSalesBook;
		this.productName = productName;
		this.batchNumber = batchNumber;
		this.recentAllotment = recentAllotment;
	...
	public Integer getRecentAllotment() {
		return recentAllotment;
	}

	public void setRecentAllotment(Integer recentAllotment) {
		this.recentAllotment = recentAllotment;
	}
