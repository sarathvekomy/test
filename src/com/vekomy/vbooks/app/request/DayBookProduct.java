...
public class DayBookProduct  extends Response {
	...
	@JsonIgnore
	private Integer closeingStockTemp;
	...
	public Integer getCloseingStockTemp() {
		return closeingStockTemp;
	}

	public void setCloseingStockTemp(Integer closeingStockTemp) {
		this.closeingStockTemp = closeingStockTemp;
	}
}