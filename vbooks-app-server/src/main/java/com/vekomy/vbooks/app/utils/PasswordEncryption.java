/**
 * com.vekomy.vbooks.app.utils.PasswordEncryption.java
 *
...
public class PasswordEncryption {
	...
	public static String encryptPassword(String password) {
		...
		try {
			MessageDigest messageDigestEncrypt = MessageDigest
					.getInstance("MD5");
			messageDigestEncrypt.update(password.getBytes(), 0,
					password.length());
			convertedPassword = new BigInteger(1, messageDigestEncrypt.digest())
					.toString(16);
		} catch (Exception e) {
