...
public class VbOrganization implements java.io.Serializable {
	...
	public VbOrganization(String superUserName, String name,
			...
			Set vbDeliveryNotes, Set vbProductInventoryTransactions,
			Set vbDeliveryNoteChangeRequests, Set vbSalesReturns,
			Set vbCustomerChangeRequests, Set vbEmployees,
			Set vbSalesReturnChangeRequests, Set vbDayBookChangeRequests,
			Set vbOrganizationMappingsForMainBranchId, Set vbDayBooks,
			Set vbOrganizationMappingsForSubBranchId, Set vbJournals,
			Set vbCustomerAdvanceInfos, Set vbProducts, Set vbAddressTypeses,
			Set vbProductCustomerCosts, Set vbCustomers,
			Set vbEmployeeCustomers, Set vbPaymentTypeses,
